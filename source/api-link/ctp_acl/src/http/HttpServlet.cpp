...
//    logger("type=%d", type);
//    const char *param = req.getHeader("InvestorID");
//    if (NULL == param) {
//        logger_error("InvestorID is null");
//        res.format("InvestorID is null");
//    } else {
//        logger("InvestorID = %s", param);
//    }
//    bool vector_flag =false;
//    int xiaobiao = 0;
//    for(auto v = sm_vTrade.begin(); v != sm_vTrade.end(); ++v, ++xiaobiao) {
//        if (strcmp(v->first, param) == 0) {
//            CustomTradeSpi* tradeSpi = (CustomTradeSpi*)v->second;
//            req.getSession().setAttribute("xiaobiao", (char *)xiaobiao);
//            vector_flag = true;
//            break;
//        }
//    }

...
public:
    ...
    void loopCmd();
    void printHelp();
    void SetMdApi(CThostFtdcMdApi *mdApi);
    void SetAccount(std::shared_ptr<Account> account);

    int subscribeMarketData(const char *ppInstrumentID, int nCount);
    int unSubscribeMarketData(const char *ppInstrumentID, int nCount);

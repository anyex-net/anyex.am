...
case $1 in
  ctp_*)
    ...
    cmake ../.. -DCMAKE_BUILD_TYPE=Debug -DSTP=OFF -DOPENCTP=OFF && make
  ...
  stp_*)
    ...
    cmake ../.. -DCMAKE_BUILD_TYPE=Debug -DSTP=ON -DOPENCTP=OFF && make
  ...
  openctp_*)
    ...
    cmake ../.. -DCMAKE_BUILD_TYPE=Debug -DSTP=OFF -DOPENCTP=ON && make

...
//交易IP地址与端口
#define TRADE_DEFAULT_IP		("123.161.206.213")
#define TRADE_DEFAULT_PORT	(8383)

//授权码
#define TRADE_DEFAULT_AUTHCODE	("")

//用户名密码
#define TRADE_DEFAULT_USERNAME	("RDGJ06")
#define TRADE_DEFAULT_PASSWORD	("1234567")

//下单
#define TRADE_DEFAULT_ACCOUNT_NO		(TRADE_DEFAULT_USERNAME)
#define TRADE_DEFAULT_EXCHANGE_NO		("NYMEX")
#define TRADE_DEFAULT_COMMODITY_TYPE	(TAPI_COMMODITY_TYPE_FUTURES)
#define TRADE_DEFAULT_COMMODITY_NO	    ("CL")
#define TRADE_DEFAULT_CONTRACT_NO		("2104")
#define TRADE_DEFAULT_ORDER_TYPE		(TAPI_ORDER_TYPE_MARKET)
#define TRADE_DEFAULT_ORDER_SIDE		(TAPI_SIDE_BUY)
#define TRADE_DEFAULT_ORDER_PRICE		(0)
#define TRADE_DEFAULT_ORDER_QTY		(1)

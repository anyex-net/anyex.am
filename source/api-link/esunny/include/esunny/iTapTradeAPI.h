...
namespace ITapTrade
{
	...
	public:
		...
		* @ingroup G_T_Spot
		*/
		virtual  void TAP_CDECL  OnRspQryUserTrustDevice(ITapTrade::TAPIUINT32 sessionID, ITapTrade::TAPIINT32 errorCode, ITapTrade::TAPIYNFLAG isLast, const  ITapTrade::TapAPIUserTrustDeviceQryRsp *info) = 0;
		...
		* @ingroup G_T_Spot
		*/
		virtual  void TAP_CDECL  OnRspAddUserTrustDevice(ITapTrade::TAPIUINT32 sessionID, ITapTrade::TAPIINT32 errorCode, const ITapTrade::TapAPIUserTrustDeviceAddRsp *info) = 0;
		...
		* @ingroup G_T_Spot
		*/
		virtual  void TAP_CDECL  OnRspDelUserTrustDevice(ITapTrade::TAPIUINT32 sessionID, ITapTrade::TAPIINT32 errorCode, const ITapTrade::TapAPIUserTrustDeviceDelRsp *info) = 0;
		...
		* @ingroup G_T_Spot
		*/
		virtual  void TAP_CDECL  OnRtnAddUserTrustDevice(const ITapTrade::TapAPIUserTrustDeviceAddRsp *info) = 0;
		...
		* @ingroup G_T_Spot
		*/
		virtual  void TAP_CDECL  OnRtnDelUserTrustDevice(const ITapTrade::TapAPIUserTrustDeviceDelRsp *info) = 0;
	};
    ...
    extern "C" {
		...
		*			所有地址切换完后，回到第一个地址循环重连。主动断开可以终止续连。

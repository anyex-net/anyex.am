...
#include "../../include/thread/QuoteThread.h"
#include "TapAPIError.h"
#include "cstring"
#include <chrono>
#include <thread>
#include <map>
#include "../../include/common/utils/EsunnyUtil.h"
...
void QuoteThread::init()
{
    ...
    strcpy(stAppInfo.AuthCode, QUOTE_ACCOUNTS[this->AccountNo]->getAuthCode());
    ...
    objQuote.setAccount(QUOTE_ACCOUNTS[this->AccountNo]);
}

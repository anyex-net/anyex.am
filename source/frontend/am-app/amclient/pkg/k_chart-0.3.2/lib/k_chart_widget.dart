...
class _KChartWidgetState extends State<KChartWidget>
  ...
  void initState() {
    ...
    deviation = widget.deviationwidth;
  }

  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    mWidth = widget.widgetWidth == 0.0 ? MediaQuery.of(context).size.width :  widget.widgetWidth;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onLongPressStart: (details) {
        isLongPress = true;
        if (mSelectX != details.globalPosition.dx + deviation) {
          mSelectX = details.globalPosition.dx + deviation;
          notifyChanged();
        }
      },

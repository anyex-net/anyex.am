<template>
  <div class="app-container">
    ...
    <el-table
      v-loading="stpNpSpotOrderHisLoading"
      :data="stpNpSpotOrderHisData"
    ...
    />
    <el-dialog title="内盘现货委托订单" :visible.sync="stpNpSpotOrderHisDialog" :close-on-click-modal="false" width="600">
      <el-form
        ref="stpNpSpotOrderHisForm"
        :model="stpNpSpotOrderHisForm"
        label-width="150px"
        class="stpNpSpotOrderHisForm"
      >
        <el-row>
          <el-col :span="8">
            <el-form-item label="AM平台账户ID" prop="accountId">
              <el-input v-model="stpNpSpotOrderHisForm.accountId" placeholder="请输入AM平台账户ID" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="经纪公司代码" prop="brokerID">
              <el-input v-model="stpNpSpotOrderHisForm.brokerID" placeholder="请输入经纪公司代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所代码" prop="exchangeID">
              <el-input v-model="stpNpSpotOrderHisForm.exchangeID" placeholder="请输入交易所代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="投资者代码" prop="investorID">
              <el-input v-model="stpNpSpotOrderHisForm.investorID" placeholder="请输入投资者代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="投资单元代码" prop="businessUnitID">
              <el-input v-model="stpNpSpotOrderHisForm.businessUnitID" placeholder="请输入投资单元代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="股东账户代码" prop="shareholderID">
              <el-input v-model="stpNpSpotOrderHisForm.shareholderID" placeholder="请输入股东账户代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="证券代码" prop="securityID">
              <el-input v-model="stpNpSpotOrderHisForm.securityID" placeholder="请输入证券代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="买卖方向" prop="direction">
              <el-input v-model="stpNpSpotOrderHisForm.direction" placeholder="请输入买卖方向" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单价格条件" prop="orderPriceType">
              <el-input v-model="stpNpSpotOrderHisForm.orderPriceType" placeholder="请输入报单价格条件" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="有效期类型" prop="timeCondition">
              <el-input v-model="stpNpSpotOrderHisForm.timeCondition" placeholder="请输入有效期类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="成交量类型" prop="volumeCondition">
              <el-input v-model="stpNpSpotOrderHisForm.volumeCondition" placeholder="请输入成交量类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="价格" prop="limitPrice">
              <el-input v-model="stpNpSpotOrderHisForm.limitPrice" placeholder="请输入价格" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="数量" prop="volumeTotalOriginal">
              <el-input v-model="stpNpSpotOrderHisForm.volumeTotalOriginal" placeholder="请输入数量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="港股通订单数量类型" prop="lotType">
              <el-input v-model="stpNpSpotOrderHisForm.lotType" placeholder="请输入港股通订单数量类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="有效日期" prop="gTDate">
              <el-input v-model="stpNpSpotOrderHisForm.gTDate" placeholder="请输入有效日期" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="委托方式" prop="operway">
              <el-input v-model="stpNpSpotOrderHisForm.operway" placeholder="请输入委托方式" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="条件检查" prop="condCheck">
              <el-input v-model="stpNpSpotOrderHisForm.condCheck" placeholder="请输入条件检查" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="字符串附加信息" prop="sInfo">
              <el-input v-model="stpNpSpotOrderHisForm.sInfo" placeholder="请输入字符串附加信息" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="整形附加信息" prop="iInfo">
              <el-input v-model="stpNpSpotOrderHisForm.iInfo" placeholder="请输入整形附加信息" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="请求编号" prop="requestID">
              <el-input v-model="stpNpSpotOrderHisForm.requestID" placeholder="请输入请求编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="前置编号" prop="frontID">
              <el-input v-model="stpNpSpotOrderHisForm.frontID" placeholder="请输入前置编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="会话编号" prop="sessionID">
              <el-input v-model="stpNpSpotOrderHisForm.sessionID" placeholder="请输入会话编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单引用" prop="orderRef">
              <el-input v-model="stpNpSpotOrderHisForm.orderRef" placeholder="请输入报单引用" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="本地报单编号" prop="orderLocalID">
              <el-input v-model="stpNpSpotOrderHisForm.orderLocalID" placeholder="请输入本地报单编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="系统报单编号" prop="orderSysID">
              <el-input v-model="stpNpSpotOrderHisForm.orderSysID" placeholder="请输入系统报单编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单状态" prop="orderStatus">
              <el-input v-model="stpNpSpotOrderHisForm.orderStatus" placeholder="请输入报单状态" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单提交状态" prop="orderSubmitStatus">
              <el-input v-model="stpNpSpotOrderHisForm.orderSubmitStatus" placeholder="请输入报单提交状态" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="状态信息" prop="statusMsg">
              <el-input v-model="stpNpSpotOrderHisForm.statusMsg" placeholder="请输入状态信息" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="已成交数量" prop="volumeTraded">
              <el-input v-model="stpNpSpotOrderHisForm.volumeTraded" placeholder="请输入已成交数量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="已撤销数量" prop="volumeCanceled">
              <el-input v-model="stpNpSpotOrderHisForm.volumeCanceled" placeholder="请输入已撤销数量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易日" prop="tradingDay">
              <el-input v-model="stpNpSpotOrderHisForm.tradingDay" placeholder="请输入交易日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="申报用户" prop="insertUser">
              <el-input v-model="stpNpSpotOrderHisForm.insertUser" placeholder="请输入申报用户" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="申报日期" prop="insertDate">
              <el-input v-model="stpNpSpotOrderHisForm.insertDate" placeholder="请输入申报日期" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="申报时间" prop="insertTime">
              <el-input v-model="stpNpSpotOrderHisForm.insertTime" placeholder="请输入申报时间" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所接收时间" prop="acceptTime">
              <el-input v-model="stpNpSpotOrderHisForm.acceptTime" placeholder="请输入交易所接收时间" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="撤销用户" prop="cancelUser">
              <el-input v-model="stpNpSpotOrderHisForm.cancelUser" placeholder="请输入撤销用户" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="撤销时间" prop="cancelTime">
              <el-input v-model="stpNpSpotOrderHisForm.cancelTime" placeholder="请输入撤销时间" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="经纪公司部门代码" prop="departmentID">
              <el-input v-model="stpNpSpotOrderHisForm.departmentID" placeholder="请输入经纪公司部门代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="资金账户代码(对应AccountID)" prop="accountNo">
              <el-input v-model="stpNpSpotOrderHisForm.accountNo" placeholder="请输入资金账户代码(对应AccountID)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="币种" prop="currencyID">
              <el-input v-model="stpNpSpotOrderHisForm.currencyID" placeholder="请输入币种" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易单元代码" prop="pbuID">
              <el-input v-model="stpNpSpotOrderHisForm.pbuID" placeholder="请输入交易单元代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="成交金额" prop="turnover">
              <el-input v-model="stpNpSpotOrderHisForm.turnover" placeholder="请输入成交金额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="报单类型" prop="orderType">
              <el-input v-model="stpNpSpotOrderHisForm.orderType" placeholder="请输入报单类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="用户端产品信息" prop="userProductInfo">
              <el-input v-model="stpNpSpotOrderHisForm.userProductInfo" placeholder="请输入用户端产品信息" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="强平原因(两融专用)" prop="forceCloseReason">
              <el-input v-model="stpNpSpotOrderHisForm.forceCloseReason" placeholder="请输入强平原因(两融专用)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="信用头寸编号(两融专用)" prop="creditQuotaID">
              <el-input v-model="stpNpSpotOrderHisForm.creditQuotaID" placeholder="请输入信用头寸编号(两融专用)" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="头寸类型(两融专用)" prop="creditQuotaType">
              <el-input v-model="stpNpSpotOrderHisForm.creditQuotaType" placeholder="请输入头寸类型(两融专用)" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="信用负债编号(两融专用)" prop="creditDebtID">
              <el-input v-model="stpNpSpotOrderHisForm.creditDebtID" placeholder="请输入信用负债编号(两融专用)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="IP地址" prop="iPAddress">
              <el-input v-model="stpNpSpotOrderHisForm.iPAddress" placeholder="请输入IP地址" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="Mac地址" prop="macAddress">
              <el-input v-model="stpNpSpotOrderHisForm.macAddress" placeholder="请输入Mac地址" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="回报附加浮点型数据信息" prop="rtnFloatInfo">
              <el-input v-model="stpNpSpotOrderHisForm.rtnFloatInfo" placeholder="请输入回报附加浮点型数据信息" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="回报附加整型数据" prop="rtnIntInfo">
              <el-input v-model="stpNpSpotOrderHisForm.rtnIntInfo" placeholder="请输入回报附加整型数据" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="错误代码" prop="errorID">
              <el-input v-model="stpNpSpotOrderHisForm.errorID" placeholder="请输入错误代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="错误信息" prop="errorMsg">
              <el-input v-model="stpNpSpotOrderHisForm.errorMsg" placeholder="请输入错误信息" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="费息折扣券编号（0表示不使用折扣券）(两融专用)" prop="discountCouponID">
              <el-input v-model="stpNpSpotOrderHisForm.discountCouponID" placeholder="请输入费息折扣券编号（0表示不使用折扣券）(两融专用)" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="操作标志" prop="actionFlag">
              <el-input v-model="stpNpSpotOrderHisForm.actionFlag" placeholder="请输入操作标志" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单操作引用" prop="orderActionRef">
              <el-input v-model="stpNpSpotOrderHisForm.orderActionRef" placeholder="请输入报单操作引用" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="系统撤单编号" prop="cancelOrderSysID">
              <el-input v-model="stpNpSpotOrderHisForm.cancelOrderSysID" placeholder="请输入系统撤单编号" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
export default {
  name: 'StpNpSpotOrderHisName',
  data() {
    return {
      stpNpSpotOrderHisLoading: true,
      stpNpSpotOrderHisDialog: false,
      stpNpSpotOrderHisData: [],
      commodityTypeSelects: [],
      dicts: [],
      stpNpSpotOrderHisForm: {
        'id': '',
        'accountId': '',
        'brokerID': '',
        'exchangeID': '',
  ...
  methods: {
    ...
    doSearch: function(data, type) {
      ...
      this.stpNpSpotOrderHisLoading = true;
      this.$http({
        url: '/npspot/stpNpSpotOrderHis/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.stpNpSpotOrderHisData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.stpNpSpotOrderHisLoading = false;
        } else {
    ...
    dialogAdd: function() {
      ...
      this.stpNpSpotOrderHisDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.stpNpSpotOrderHisForm) {
        this.$refs.stpNpSpotOrderHisForm.resetFields();
      }
      this.$http({
        url: '/npspot/stpNpSpotOrderHis/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/npspot/stpNpSpotOrderHis/save',
            method: 'post',
            data: this.stpNpSpotOrderHisForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.stpNpSpotOrderHisDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/npspot/stpNpSpotOrderHis/del',
          method: 'post',
          data: {
            ids: column.id
          }

...
<!--        <el-button type="success" icon="el-icon-circle-plus" @click="dialogAdd()">添加</el-button>-->
    ...
    <el-table
      v-loading="subStpNpSpotOrderHisLoading"
      :data="subStpNpSpotOrderHisData"
    ...
    >
      ...
      <el-table-column prop="orderPriceType" label="报单价格条件" />
      <el-table-column prop="timeCondition" label="有效期类型" />
      <el-table-column prop="volumeCondition" label="成交量类型" />
      ...
      <el-table-column prop="orderStatus" label="报单状态" />
      <el-table-column prop="orderSubmitStatus" label="报单提交状态" />
      ...
      <el-table-column prop="orderType" label="报单类型" />
    ...
    <el-dialog
      title="子账户委托订单历史表管理"
      :visible.sync="subStpNpSpotOrderHisDialog"
      :close-on-click-modal="false"
      width="600"
    >
      <el-form
        ref="subStpNpSpotOrderHisForm"
        :model="subStpNpSpotOrderHisForm"
        :rules="subStpNpSpotOrderHisRules"
        label-width="150px"
        class="subStpNpSpotOrderHisForm"
      >
        <el-row>
          <el-col :span="8">
                        <el-form-item label="主键" prop="id">
                          <el-input v-model="subStpNpSpotOrderHisForm.id" placeholder="请输入主键"/>
                        </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="子账户AM平台账户ID" prop="subAccountId">
              <el-input v-model="subStpNpSpotOrderHisForm.subAccountId" placeholder="请输入子账户AM平台账户ID"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所代码" prop="exchangeID">
              <el-select v-model="subStpNpSpotOrderHisForm.exchangeID" clearable placeholder="请输入交易所代码">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="投资者代码" prop="investorID">
              <el-input v-model="subStpNpSpotOrderHisForm.investorID" placeholder="请输入投资者代码"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="投资单元代码" prop="businessUnitID">
              <el-input v-model="subStpNpSpotOrderHisForm.businessUnitID" placeholder="请输入投资单元代码"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="股东账户代码" prop="shareholderID">
              <el-input v-model="subStpNpSpotOrderHisForm.shareholderID" placeholder="请输入股东账户代码"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="证券代码" prop="securityID">
              <el-input v-model="subStpNpSpotOrderHisForm.securityID" placeholder="请输入证券代码"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="买卖方向" prop="direction">
              <el-select v-model="subStpNpSpotOrderHisForm.direction" clearable placeholder="请输入买卖方向">
          ...
          <el-col :span="8">
            <el-form-item label="报单价格条件" prop="orderPriceType">
              <el-select v-model="subStpNpSpotOrderHisForm.orderPriceType" clearable placeholder="请输入报单价格条件">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="有效期类型" prop="timeCondition">
              <el-select v-model="subStpNpSpotOrderHisForm.timeCondition" clearable placeholder="请输入有效期类型">
          ...
          <el-col :span="8">
            <el-form-item label="成交量类型" prop="volumeCondition">
              <el-select v-model="subStpNpSpotOrderHisForm.volumeCondition" clearable placeholder="请输入成交量类型">
          ...
          <el-col :span="8">
            <el-form-item label="价格" prop="limitPrice">
              <el-input v-model="subStpNpSpotOrderHisForm.limitPrice" placeholder="请输入价格"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="数量" prop="volumeTotalOriginal">
              <el-input v-model="subStpNpSpotOrderHisForm.volumeTotalOriginal" placeholder="请输入数量"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="港股通订单数量类型" prop="lotType">
              <el-input v-model="subStpNpSpotOrderHisForm.lotType" placeholder="请输入港股通订单数量类型"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="有效日期" prop="gTDate">
              <el-input v-model="subStpNpSpotOrderHisForm.gTDate" placeholder="请输入有效日期"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="委托方式" prop="operway">
              <el-input v-model="subStpNpSpotOrderHisForm.operway" placeholder="请输入委托方式"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="条件检查" prop="condCheck">
              <el-input v-model="subStpNpSpotOrderHisForm.condCheck" placeholder="请输入条件检查"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="字符串附加信息" prop="sInfo">
              <el-input v-model="subStpNpSpotOrderHisForm.sInfo" placeholder="请输入字符串附加信息"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="整形附加信息" prop="iInfo">
              <el-input v-model="subStpNpSpotOrderHisForm.iInfo" placeholder="请输入整形附加信息"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="请求编号" prop="requestID">
              <el-input v-model="subStpNpSpotOrderHisForm.requestID" placeholder="请输入请求编号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="前置编号" prop="frontID">
              <el-input v-model="subStpNpSpotOrderHisForm.frontID" placeholder="请输入前置编号"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="会话编号" prop="sessionID">
              <el-input v-model="subStpNpSpotOrderHisForm.sessionID" placeholder="请输入会话编号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单引用" prop="orderRef">
              <el-input v-model="subStpNpSpotOrderHisForm.orderRef" placeholder="请输入报单引用"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="本地报单编号" prop="orderLocalID">
              <el-input v-model="subStpNpSpotOrderHisForm.orderLocalID" placeholder="请输入本地报单编号"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="系统报单编号" prop="orderSysID">
              <el-input v-model="subStpNpSpotOrderHisForm.orderSysID" placeholder="请输入系统报单编号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单状态" prop="orderStatus">
              <el-select v-model="subStpNpSpotOrderHisForm.orderStatus" clearable placeholder="请输入报单状态">
          ...
          <el-col :span="8">
            <el-form-item label="报单提交状态" prop="orderSubmitStatus">
              <el-select v-model="subStpNpSpotOrderHisForm.orderSubmitStatus" clearable placeholder="请输入报单提交状态">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="状态信息" prop="statusMsg">
              <el-input v-model="subStpNpSpotOrderHisForm.statusMsg" placeholder="请输入状态信息"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="已成交数量" prop="volumeTraded">
              <el-input v-model="subStpNpSpotOrderHisForm.volumeTraded" placeholder="请输入已成交数量"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="已撤销数量" prop="volumeCanceled">
              <el-input v-model="subStpNpSpotOrderHisForm.volumeCanceled" placeholder="请输入已撤销数量"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易日" prop="tradingDay">
              <el-input v-model="subStpNpSpotOrderHisForm.tradingDay" placeholder="请输入交易日"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="申报用户" prop="insertUser">
              <el-input v-model="subStpNpSpotOrderHisForm.insertUser" placeholder="请输入申报用户"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="申报日期" prop="insertDate">
              <el-input v-model="subStpNpSpotOrderHisForm.insertDate" placeholder="请输入申报日期"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="申报时间" prop="insertTime">
              <el-input v-model="subStpNpSpotOrderHisForm.insertTime" placeholder="请输入申报时间"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所接收时间" prop="acceptTime">
              <el-input v-model="subStpNpSpotOrderHisForm.acceptTime" placeholder="请输入交易所接收时间"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="撤销用户" prop="cancelUser">
              <el-input v-model="subStpNpSpotOrderHisForm.cancelUser" placeholder="请输入撤销用户"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="撤销时间" prop="cancelTime">
              <el-input v-model="subStpNpSpotOrderHisForm.cancelTime" placeholder="请输入撤销时间"/>
            </el-form-item>
          </el-col>
          <!--        </el-row>-->
          <!--        <el-row>-->
          <el-col :span="8">
            <el-form-item label="币种" prop="currencyID">
              <el-select v-model="subStpNpSpotOrderHisForm.currencyID" clearable placeholder="请输入币种">
          ...
          <el-col :span="8">
            <el-form-item label="交易单元代码" prop="pbuID">
              <el-input v-model="subStpNpSpotOrderHisForm.pbuID" placeholder="请输入交易单元代码"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="成交金额" prop="turnover">
              <el-input v-model="subStpNpSpotOrderHisForm.turnover" placeholder="请输入成交金额"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="报单类型" prop="orderType">
              <el-select v-model="subStpNpSpotOrderHisForm.orderType" clearable placeholder="请输入报单类型">
          ...
          <el-col :span="8">
            <el-form-item label="用户端产品信息" prop="userProductInfo">
              <el-input v-model="subStpNpSpotOrderHisForm.userProductInfo" placeholder="请输入用户端产品信息"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="强平原因(两融专用)" prop="forceCloseReason">
              <el-input v-model="subStpNpSpotOrderHisForm.forceCloseReason" placeholder="请输入强平原因(两融专用)"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="信用头寸编号(两融专用)" prop="creditQuotaID">
              <el-input v-model="subStpNpSpotOrderHisForm.creditQuotaID" placeholder="请输入信用头寸编号(两融专用)"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="头寸类型(两融专用)" prop="creditQuotaType">
              <el-input v-model="subStpNpSpotOrderHisForm.creditQuotaType" placeholder="请输入头寸类型(两融专用)"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="信用负债编号(两融专用)" prop="creditDebtID">
              <el-input v-model="subStpNpSpotOrderHisForm.creditDebtID" placeholder="请输入信用负债编号(两融专用)"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="IP地址" prop="iPAddress">
              <el-input v-model="subStpNpSpotOrderHisForm.iPAddress" placeholder="请输入IP地址"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="Mac地址" prop="macAddress">
              <el-input v-model="subStpNpSpotOrderHisForm.macAddress" placeholder="请输入Mac地址"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="回报附加浮点型数据信息" prop="rtnFloatInfo">
              <el-input v-model="subStpNpSpotOrderHisForm.rtnFloatInfo" placeholder="请输入回报附加浮点型数据信息"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="回报附加整型数据" prop="rtnIntInfo">
              <el-input v-model="subStpNpSpotOrderHisForm.rtnIntInfo" placeholder="请输入回报附加整型数据"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="错误代码" prop="errorID">
              <el-input v-model="subStpNpSpotOrderHisForm.errorID" placeholder="请输入错误代码"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="错误信息" prop="errorMsg">
              <el-input v-model="subStpNpSpotOrderHisForm.errorMsg" placeholder="请输入错误信息"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="费息折扣券编号（0表示不使用折扣券）(两融专用)" prop="discountCouponID">
              <el-input v-model="subStpNpSpotOrderHisForm.discountCouponID" placeholder="请输入费息折扣券编号（0表示不使用折扣券）(两融专用)"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="操作标志" prop="actionFlag">
              <el-input v-model="subStpNpSpotOrderHisForm.actionFlag" placeholder="请输入操作标志"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单操作引用" prop="orderActionRef">
              <el-input v-model="subStpNpSpotOrderHisForm.orderActionRef" placeholder="请输入报单操作引用"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="系统撤单编号" prop="cancelOrderSysID">
              <el-input v-model="subStpNpSpotOrderHisForm.cancelOrderSysID" placeholder="请输入系统撤单编号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结手续费" prop="frozenCommission">
              <el-input v-model="subStpNpSpotOrderHisForm.frozenCommission" placeholder="请输入冻结手续费"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结资金" prop="frozenCash">
              <el-input v-model="subStpNpSpotOrderHisForm.frozenCash" placeholder="请输入冻结资金"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="剩余冻结手续费" prop="remainFrozenCommission">
              <el-input v-model="subStpNpSpotOrderHisForm.remainFrozenCommission" placeholder="请输入剩余冻结手续费"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="剩余冻结资金" prop="remainFrozenCash">
              <el-input v-model="subStpNpSpotOrderHisForm.remainFrozenCash" placeholder="请输入剩余冻结资金"/>
            </el-form-item>
          </el-col>
        </el-row>
<!--        <el-form-item>-->
<!--          <el-button type="success" @click="doSubmit('subStpNpSpotOrderHisForm')">提交</el-button>-->
<!--        </el-form-item>-->
      </el-form>
    </el-dialog>
  </div>
...
<script>
export default {
  name: 'SubStpNpSpotOrderHisName',
  data() {
    return {
      subStpNpSpotOrderHisLoading: true,
      subStpNpSpotOrderHisDialog: false,
      subStpNpSpotOrderHisData: [],
      commodityTypeSelects: [],
      dicts: [],
      subStpNpSpotOrderHisForm: {
        'id': '',
        'subAccountId': '',
        'exchangeID': '',
        'investorID': '',
  ...
  methods: {
    ...
    doInitData() {
      this.$http({
        url: '/npspot/dict/subStpNpSpotOrderHis',
        method: 'get'
      }).then(res => {
        if (res.code === 200) {
    ...
    doSearch: function(data, type) {
      ...
      this.subStpNpSpotOrderHisLoading = true;
      this.$http({
        url: '/npspot/subStpNpSpotOrderHis/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.subStpNpSpotOrderHisData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.subStpNpSpotOrderHisLoading = false;
        } else {
    ...
    dialogAdd: function() {
      ...
      this.subStpNpSpotOrderHisDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.subStpNpSpotOrderHisForm) {
        this.$refs.subStpNpSpotOrderHisForm.resetFields();
      }
      this.$http({
        url: '/npspot/subStpNpSpotOrderHis/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/npspot/subStpNpSpotOrderHis/save',
            method: 'post',
            data: this.subStpNpSpotOrderHisForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.subStpNpSpotOrderHisDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/npspot/subStpNpSpotOrderHis/del',
          method: 'post',
          data: {
            ids: column.id
          }

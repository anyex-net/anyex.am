  ...
  <div class="app-container">
    <el-form ref="searchForm" :model="searchForm" :inline="true" size="mini">
      ...
      <el-form-item label="证券名称">
        <el-input v-model="searchForm.instrumentName" clearable placeholder="请输入证券名称"></el-input>
      </el-form-item>
      ...
      <el-form-item label="产品代码">
        <el-select v-model="searchForm.productID" clearable placeholder="请输入产品代码">
          <el-option v-for="data in productID" :key="data.key" :label="data.value" :value="data.key" />
        </el-select>
      </el-form-item>
    ...
    <el-table
      v-loading="npSpotExchangeInstrumentLoading"
      :data="npSpotExchangeInstrumentData"
    ...
    >
      ...
      <el-table-column prop="volumeMultiple" label="证券数量乘数" />
      ...
      <el-table-column prop="instLifePhase" label="证券生命周期状态" />
      <el-table-column prop="isTrading" label="当前是否交易" />
      <el-table-column prop="positionType" label="持仓类型" />
      <el-table-column prop="positionDateType" label="持仓日期类型" />
      <el-table-column prop="longMarginRatio" label="多头保证金率" />
      <el-table-column prop="shortMarginRatio" label="空头保证金率" />
      <el-table-column prop="maxMarginSideAlgorithm" label="是否使用大额单边保证金算法" />
      <el-table-column prop="underlyingInstrID" label="基础商品代码" />
      <el-table-column prop="strikePrice" label="执行价" />
      <el-table-column prop="optionsType" label="期权类型" />
      <el-table-column prop="underlyingMultiple" label="证券基础商品乘数" />
      <el-table-column prop="combinationType" label="组合类型" />
    ...
    />
    <el-dialog
      title="内盘现货交易所证券信息表管理"
      :visible.sync="npSpotExchangeInstrumentDialog"
      :close-on-click-modal="false"
      width="70%"
    >
      <el-form
        ref="npSpotExchangeInstrumentForm"
        :model="npSpotExchangeInstrumentForm"
        :rules="npSpotExchangeInstrumentRules"
        label-width="150px"
        class="npSpotExchangeInstrumentForm"
      >
        <el-row>
          <el-col :span="8">
            <el-form-item label="证券代码" prop="instrumentID">
              <el-input v-model="npSpotExchangeInstrumentForm.instrumentID" placeholder="请输入证券代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所代码" prop="exchangeID">
              <el-input v-model="npSpotExchangeInstrumentForm.exchangeID" placeholder="请输入交易所代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="证券名称" prop="instrumentName">
              <el-input v-model="npSpotExchangeInstrumentForm.instrumentName" placeholder="请输入证券名称" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="证券在交易所的代码" prop="exchangeInstID">
              <el-input v-model="npSpotExchangeInstrumentForm.exchangeInstID" placeholder="请输入证券在交易所的代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="产品代码" prop="productID">
              <el-select v-model="npSpotExchangeInstrumentForm.productID" placeholder="请输入产品代码">
                <el-option v-for="data in productID" :key="data.key" :label="data.value" :value="data.key" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="产品类型" prop="productClass">
              <el-input v-model="npSpotExchangeInstrumentForm.productClass" placeholder="请选择产品类型" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交割年份" prop="deliveryYear">
              <el-input v-model="npSpotExchangeInstrumentForm.deliveryYear" placeholder="请输入交割年份" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交割月" prop="deliveryMonth">
              <el-input v-model="npSpotExchangeInstrumentForm.deliveryMonth" placeholder="请输入交割月" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="市价单最大下单量" prop="maxMarketOrderVolume">
              <el-input v-model="npSpotExchangeInstrumentForm.maxMarketOrderVolume" placeholder="请输入市价单最大下单量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="市价单最小下单量" prop="minMarketOrderVolume">
              <el-input v-model="npSpotExchangeInstrumentForm.minMarketOrderVolume" placeholder="请输入市价单最小下单量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="限价单最大下单量" prop="maxLimitOrderVolume">
              <el-input v-model="npSpotExchangeInstrumentForm.maxLimitOrderVolume" placeholder="请输入限价单最大下单量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="限价单最小下单量" prop="minLimitOrderVolume">
              <el-input v-model="npSpotExchangeInstrumentForm.minLimitOrderVolume" placeholder="请输入限价单最小下单量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="证券数量乘数" prop="volumeMultiple">
              <el-input v-model="npSpotExchangeInstrumentForm.volumeMultiple" placeholder="请输入证券数量乘数" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="最小变动价位" prop="priceTick">
              <el-input v-model="npSpotExchangeInstrumentForm.priceTick" placeholder="请输入最小变动价位" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="创建日" prop="createDate">
              <el-input v-model="npSpotExchangeInstrumentForm.createDate" placeholder="请输入创建日" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上市日" prop="openDate">
              <el-input v-model="npSpotExchangeInstrumentForm.openDate" placeholder="请输入上市日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="到期日" prop="expireDate">
              <el-input v-model="npSpotExchangeInstrumentForm.expireDate" placeholder="请输入到期日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开始交割日" prop="startDelivDate">
              <el-input v-model="npSpotExchangeInstrumentForm.startDelivDate" placeholder="请输入开始交割日" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="结束交割日" prop="endDelivDate">
              <el-input v-model="npSpotExchangeInstrumentForm.endDelivDate" placeholder="请输入结束交割日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="证券生命周期状态" prop="instLifePhase">
              <el-input v-model="npSpotExchangeInstrumentForm.instLifePhase" placeholder="请选择证券生命周期状态" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="当前是否交易" prop="isTrading">
              <el-input v-model="npSpotExchangeInstrumentForm.isTrading" placeholder="请输入当前是否交易" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="持仓类型" prop="positionType">
              <el-input v-model="npSpotExchangeInstrumentForm.positionType" placeholder="请选择持仓类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="持仓日期类型" prop="positionDateType">
              <el-input v-model="npSpotExchangeInstrumentForm.positionDateType" placeholder="请选择持仓日期类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="多头保证金率" prop="longMarginRatio">
              <el-input v-model="npSpotExchangeInstrumentForm.longMarginRatio" placeholder="请输入多头保证金率" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="空头保证金率" prop="shortMarginRatio">
              <el-input v-model="npSpotExchangeInstrumentForm.shortMarginRatio" placeholder="请输入空头保证金率" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否使用大额单边保证金算法" prop="maxMarginSideAlgorithm">
              <el-input v-model="npSpotExchangeInstrumentForm.maxMarginSideAlgorithm" placeholder="请选择是否使用大额单边保证金算法" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="基础商品代码" prop="underlyingInstrID">
              <el-input v-model="npSpotExchangeInstrumentForm.underlyingInstrID" placeholder="请输入基础商品代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="执行价" prop="strikePrice">
              <el-input v-model="npSpotExchangeInstrumentForm.strikePrice" placeholder="请输入执行价" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="期权类型" prop="optionsType">
              <el-input v-model="npSpotExchangeInstrumentForm.optionsType" placeholder="请输入期权类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="证券基础商品乘数" prop="underlyingMultiple">
              <el-input v-model="npSpotExchangeInstrumentForm.underlyingMultiple" placeholder="请输入证券基础商品乘数" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="组合类型" prop="combinationType">
              <el-input v-model="npSpotExchangeInstrumentForm.combinationType" placeholder="请输入组合类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="启用状态" prop="enableStatus">
              <el-select v-model="npSpotExchangeInstrumentForm.enableStatus" placeholder="请选择启用状态">
                <el-option key="enable" label="是" value="enable" />
                <el-option key="disable" label="否" value="disable" />
              </el-select>
            </el-form-item>
        ...
        <el-row>
          <el-col :span="24" align="center">
            <el-form-item>
              <el-button type="success" @click="doSubmit('npSpotExchangeInstrumentForm')">提交</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  data() {
    return {
      npSpotExchangeInstrumentLoading: true,
      npSpotExchangeInstrumentDialog: false,
      npSpotExchangeInstrumentData: [],
      productID: [],
      npSpotExchangeInstrumentForm: {
        'id': '',
        'instrumentID': '',
        'exchangeID': '',
        'instrumentName': '',
      ...
      npSpotExchangeInstrumentRules: {
        ...
        exchangeInstID: [
          { required: true, message: '证券在交易所的代码不可为空', trigger: 'change' }
        ],
        productID: [
        ...
        volumeMultiple: [
          { required: true, message: '证券数量乘数不可为空', trigger: 'change' }
        ],
        priceTick: [
        ...
        */
        ...
        // ],
        instLifePhase: [
          { required: true, message: '证券生命周期状态不可为空', trigger: 'change' }
        ],
        isTrading: [
        ...
        underlyingMultiple: [
          { required: true, message: '证券基础商品乘数不可为空', trigger: 'change' }
        ],
        combinationType: [
  ...
  methods: {
    ...
    doInitData() {
      this.$http({
        url: '/npspot/dict/npSpotProductID',
        method: 'get'
      }).then(res => {
        if (res.code === 200) {
          this.productID = res.object;
        }
      }).catch(error => {
        console.log(error);
      });
    ...
    doSearch: function(data, type) {
      ...
      this.npSpotExchangeInstrumentLoading = true;
      this.$http({
        url: '/npspot/npSpotExchangeInstrument/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.npSpotExchangeInstrumentData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.npSpotExchangeInstrumentLoading = false;
        } else {
    ...
    dialogAdd: function() {
      this.npSpotExchangeInstrumentForm = {
        'id': '',
        'instrumentID': '',
        'exchangeID': '',
        'instrumentName': '',
      ...
      this.npSpotExchangeInstrumentDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.npSpotExchangeInstrumentForm) {
        this.$refs.npSpotExchangeInstrumentForm.resetFields();
      }
      this.$http({
        url: '/npspot/npSpotExchangeInstrument/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/npspot/npSpotExchangeInstrument/save',
            method: 'post',
            data: this.npSpotExchangeInstrumentForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.npSpotExchangeInstrumentDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/npspot/npSpotExchangeInstrument/del',
          method: 'post',
          data: {
            ids: column.id
          }

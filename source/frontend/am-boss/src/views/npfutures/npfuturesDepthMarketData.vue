<template>
  <div class="app-container">
    ...
    <el-table
      v-loading="npfuturesDepthMarketDataLoading"
      :data="npfuturesDepthMarketDataData"
    ...
    <el-dialog
      title="内盘期货深度行情表管理"
      :visible.sync="npfuturesDepthMarketDataDialog"
      :close-on-click-modal="false"
      width="600"
    >
      <el-form
        ref="npfuturesDepthMarketDataForm"
        :model="npfuturesDepthMarketDataForm"
        label-width="150px"
        class="npfuturesDepthMarketDataForm"
      >
        <el-form-item label="交易日" prop="tradingDay">
          <el-input v-model="npfuturesDepthMarketDataForm.tradingDay" placeholder="请输入交易日" />
        </el-form-item>
        <el-form-item label="合约代码" prop="instrumentID">
          <el-input v-model="npfuturesDepthMarketDataForm.instrumentID" placeholder="请输入合约代码" />
        </el-form-item>
        <el-form-item label="交易所代码" prop="exchangeID">
          <el-input v-model="npfuturesDepthMarketDataForm.exchangeID" placeholder="请输入交易所代码" />
        </el-form-item>
        <el-form-item label="合约在交易所的代码" prop="exchangeInstID">
          <el-input v-model="npfuturesDepthMarketDataForm.exchangeInstID" placeholder="请输入合约在交易所的代码" />
        </el-form-item>
        <el-form-item label="最新价" prop="lastPrice">
          <el-input v-model="npfuturesDepthMarketDataForm.lastPrice" placeholder="请输入最新价" />
        </el-form-item>
        <el-form-item label="上次结算价" prop="preSettlementPrice">
          <el-input v-model="npfuturesDepthMarketDataForm.preSettlementPrice" placeholder="请输入上次结算价" />
        </el-form-item>
        <el-form-item label="昨收盘" prop="preClosePrice">
          <el-input v-model="npfuturesDepthMarketDataForm.preClosePrice" placeholder="请输入昨收盘" />
        </el-form-item>
        <el-form-item label="昨持仓量" prop="preOpenInterest">
          <el-input v-model="npfuturesDepthMarketDataForm.preOpenInterest" placeholder="请输入昨持仓量" />
        </el-form-item>
        <el-form-item label="今开盘价" prop="openPrice">
          <el-input v-model="npfuturesDepthMarketDataForm.openPrice" placeholder="请输入今开盘价" />
        </el-form-item>
        <el-form-item label="最高价" prop="highestPrice">
          <el-input v-model="npfuturesDepthMarketDataForm.highestPrice" placeholder="请输入最高价" />
        </el-form-item>
        <el-form-item label="最低价" prop="lowestPrice">
          <el-input v-model="npfuturesDepthMarketDataForm.lowestPrice" placeholder="请输入最低价" />
        </el-form-item>
        <el-form-item label="成交数量" prop="volume">
          <el-input v-model="npfuturesDepthMarketDataForm.volume" placeholder="请输入成交数量" />
        </el-form-item>
        <el-form-item label="成交金额" prop="turnover">
          <el-input v-model="npfuturesDepthMarketDataForm.turnover" placeholder="请输入成交金额" />
        </el-form-item>
        <el-form-item label="持仓量" prop="openInterest">
          <el-input v-model="npfuturesDepthMarketDataForm.openInterest" placeholder="请输入持仓量" />
        </el-form-item>
        <el-form-item label="今收盘" prop="closePrice">
          <el-input v-model="npfuturesDepthMarketDataForm.closePrice" placeholder="请输入今收盘" />
        </el-form-item>
        <el-form-item label="本次结算价" prop="settlementPrice">
          <el-input v-model="npfuturesDepthMarketDataForm.settlementPrice" placeholder="请输入本次结算价" />
        </el-form-item>
        <el-form-item label="涨停板价" prop="upperLimitPrice">
          <el-input v-model="npfuturesDepthMarketDataForm.upperLimitPrice" placeholder="请输入涨停板价" />
        </el-form-item>
        <el-form-item label="跌停板价" prop="lowerLimitPrice">
          <el-input v-model="npfuturesDepthMarketDataForm.lowerLimitPrice" placeholder="请输入跌停板价" />
        </el-form-item>
        <el-form-item label="昨虚实度" prop="preDelta">
          <el-input v-model="npfuturesDepthMarketDataForm.preDelta" placeholder="请输入昨虚实度" />
        </el-form-item>
        <el-form-item label="今虚实度" prop="currDelta">
          <el-input v-model="npfuturesDepthMarketDataForm.currDelta" placeholder="请输入今虚实度" />
        </el-form-item>
        <el-form-item label="最后修改时间" prop="updateTime">
          <el-input v-model="npfuturesDepthMarketDataForm.updateTime" placeholder="请输入最后修改时间" />
        </el-form-item>
        <el-form-item label="最后修改毫秒" prop="updateMillisec">
          <el-input v-model="npfuturesDepthMarketDataForm.updateMillisec" placeholder="请输入最后修改毫秒" />
        </el-form-item>
        <el-form-item label="申买价一" prop="bidPrice1">
          <el-input v-model="npfuturesDepthMarketDataForm.bidPrice1" placeholder="请输入申买价一" />
        </el-form-item>
        <el-form-item label="申买量一" prop="bidVolume1">
          <el-input v-model="npfuturesDepthMarketDataForm.bidVolume1" placeholder="请输入申买量一" />
        </el-form-item>
        <el-form-item label="申卖价一" prop="askPrice1">
          <el-input v-model="npfuturesDepthMarketDataForm.askPrice1" placeholder="请输入申卖价一" />
        </el-form-item>
        <el-form-item label="申卖量一" prop="askVolume1">
          <el-input v-model="npfuturesDepthMarketDataForm.askVolume1" placeholder="请输入申卖量一" />
        </el-form-item>
        <el-form-item label="申买价二" prop="bidPrice2">
          <el-input v-model="npfuturesDepthMarketDataForm.bidPrice2" placeholder="请输入申买价二" />
        </el-form-item>
        <el-form-item label="申买量二" prop="bidVolume2">
          <el-input v-model="npfuturesDepthMarketDataForm.bidVolume2" placeholder="请输入申买量二" />
        </el-form-item>
        <el-form-item label="申卖价二" prop="askPrice2">
          <el-input v-model="npfuturesDepthMarketDataForm.askPrice2" placeholder="请输入申卖价二" />
        </el-form-item>
        <el-form-item label="申卖量二" prop="askVolume2">
          <el-input v-model="npfuturesDepthMarketDataForm.askVolume2" placeholder="请输入申卖量二" />
        </el-form-item>
        <el-form-item label="申买价三" prop="bidPrice3">
          <el-input v-model="npfuturesDepthMarketDataForm.bidPrice3" placeholder="请输入申买价三" />
        </el-form-item>
        <el-form-item label="申买量三" prop="bidVolume3">
          <el-input v-model="npfuturesDepthMarketDataForm.bidVolume3" placeholder="请输入申买量三" />
        </el-form-item>
        <el-form-item label="申卖价三" prop="askPrice3">
          <el-input v-model="npfuturesDepthMarketDataForm.askPrice3" placeholder="请输入申卖价三" />
        </el-form-item>
        <el-form-item label="申卖量三" prop="askVolume3">
          <el-input v-model="npfuturesDepthMarketDataForm.askVolume3" placeholder="请输入申卖量三" />
        </el-form-item>
        <el-form-item label="申买价四" prop="bidPrice4">
          <el-input v-model="npfuturesDepthMarketDataForm.bidPrice4" placeholder="请输入申买价四" />
        </el-form-item>
        <el-form-item label="申买量四" prop="bidVolume4">
          <el-input v-model="npfuturesDepthMarketDataForm.bidVolume4" placeholder="请输入申买量四" />
        </el-form-item>
        <el-form-item label="申卖价四" prop="askPrice4">
          <el-input v-model="npfuturesDepthMarketDataForm.askPrice4" placeholder="请输入申卖价四" />
        </el-form-item>
        <el-form-item label="申卖量四" prop="askVolume4">
          <el-input v-model="npfuturesDepthMarketDataForm.askVolume4" placeholder="请输入申卖量四" />
        </el-form-item>
        <el-form-item label="申买价五" prop="bidPrice5">
          <el-input v-model="npfuturesDepthMarketDataForm.bidPrice5" placeholder="请输入申买价五" />
        </el-form-item>
        <el-form-item label="申买量五" prop="bidVolume5">
          <el-input v-model="npfuturesDepthMarketDataForm.bidVolume5" placeholder="请输入申买量五" />
        </el-form-item>
        <el-form-item label="申卖价五" prop="askPrice5">
          <el-input v-model="npfuturesDepthMarketDataForm.askPrice5" placeholder="请输入申卖价五" />
        </el-form-item>
        <el-form-item label="申卖量五" prop="askVolume5">
          <el-input v-model="npfuturesDepthMarketDataForm.askVolume5" placeholder="请输入申卖量五" />
        </el-form-item>
        <el-form-item label="当日均价" prop="averagePrice">
          <el-input v-model="npfuturesDepthMarketDataForm.averagePrice" placeholder="请输入当日均价" />
        </el-form-item>
        <el-form-item label="业务日期" prop="actionDay">
          <el-input v-model="npfuturesDepthMarketDataForm.actionDay" placeholder="请输入业务日期" />
        </el-form-item>
        <el-form-item label="行情变动原因" prop="changeReason">
          <el-input v-model="npfuturesDepthMarketDataForm.changeReason" placeholder="请输入行情变动原因" />
        </el-form-item>
        <el-form-item label="行情更新时间" prop="longUpdateTime">
          <el-input v-model="npfuturesDepthMarketDataForm.longUpdateTime" placeholder="请输入行情更新时间" />
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
...
<script>
export default {
  name: 'NpfuturesDepthMarketDataName',
  data() {
    return {
      npfuturesDepthMarketDataLoading: true,
      npfuturesDepthMarketDataDialog: false,
      npfuturesDepthMarketDataData: [],
      commodityTypeSelects: [],
      dicts: [],
      npfuturesDepthMarketDataForm: {
        'id': '',
        'tradingDay': '',
        'instrumentID': '',
        'exchangeID': '',
  ...
  methods: {
    ...
    doInitData() {
      this.$http({
        url: '/npfutures/dict/npfuturesDepthMarketData',
        method: 'get'
      }).then(res => {
        if (res.code === 200) {
    ...
    doSearch: function(data, type) {
      ...
      this.npfuturesDepthMarketDataLoading = true;
      this.$http({
        url: '/npfutures/npfuturesDepthMarketData/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.npfuturesDepthMarketDataData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.npfuturesDepthMarketDataLoading = false;
        } else {
    ...
    dialogAdd: function() {
      this.npfuturesDepthMarketDataForm = {
        'id': '',
        'tradingDay': '',
        'instrumentID': '',
        'exchangeID': '',
      ...
      this.npfuturesDepthMarketDataDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.npfuturesDepthMarketDataForm) {
        this.$refs.npfuturesDepthMarketDataForm.resetFields();
      }
      this.$http({
        url: '/npfutures/npfuturesDepthMarketData/findBy',
        method: 'get',
        params: {
          'id': column.id
        }

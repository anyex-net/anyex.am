<template xmlns:el-col="http://www.w3.org/1999/html">
  <div class="app-container">
    ...
    <el-table
      v-loading="npfuturesOrderHisLoading"
      :data="npfuturesOrderHisData"
    ...
    />
    <el-dialog title="内盘期货委托订单表管理" :visible.sync="npfuturesOrderHisDialog" :close-on-click-modal="false" width="75%">
      <el-form
        ref="npfuturesOrderHisForm"
        :model="npfuturesOrderHisForm"
        label-width="150px"
        class="npfuturesOrderHisForm"
      >
        <el-row>
          <el-col :span=8>
            <el-form-item label="AM平台账户ID" prop="accountId">
              <el-input v-model="npfuturesOrderHisForm.accountId" placeholder="请输入AM平台账户ID" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="经纪公司代码" prop="brokerID">
              <el-input v-model="npfuturesOrderHisForm.brokerID" placeholder="请输入经纪公司代码" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="投资者代码" prop="investorID">
              <el-input v-model="npfuturesOrderHisForm.investorID" placeholder="请输入投资者代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="合约代码" prop="instrumentID">
              <el-input v-model="npfuturesOrderHisForm.instrumentID" placeholder="请输入合约代码" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="报单引用" prop="orderRef">
              <el-input v-model="npfuturesOrderHisForm.orderRef" placeholder="请输入报单引用" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="用户代码" prop="userID">
              <el-input v-model="npfuturesOrderHisForm.userID" placeholder="请输入用户代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span=8>
            <el-form-item label="报单价格条件" prop="orderPriceType">
              <el-input v-model="npfuturesOrderHisForm.orderPriceType" placeholder="请输入报单价格条件" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="买卖方向" prop="direction">
              <el-input v-model="npfuturesOrderHisForm.direction" placeholder="请输入买卖方向(0买、1卖)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="组合开平标志" prop="combOffsetFlag">
              <el-input v-model="npfuturesOrderHisForm.combOffsetFlag" placeholder="请输入组合开平标志" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="组合投机套保标志" prop="combHedgeFlag">
              <el-input v-model="npfuturesOrderHisForm.combHedgeFlag" placeholder="请输入组合投机套保标志" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="价格" prop="limitPrice">
              <el-input v-model="npfuturesOrderHisForm.limitPrice" placeholder="请输入价格" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="数量" prop="volumeTotalOriginal">
              <el-input v-model="npfuturesOrderHisForm.volumeTotalOriginal" placeholder="请输入数量" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="有效期类型" prop="timeCondition">
              <el-input v-model="npfuturesOrderHisForm.timeCondition" placeholder="请输入有效期类型" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="GTD日期" prop="gTDDate">
              <el-input v-model="npfuturesOrderHisForm.gTDDate" placeholder="请输入GTD日期" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="成交量类型" prop="volumeCondition">
              <el-input v-model="npfuturesOrderHisForm.volumeCondition" placeholder="请输入成交量类型" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="最小成交量" prop="minVolume">
              <el-input v-model="npfuturesOrderHisForm.minVolume" placeholder="请输入最小成交量" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="触发条件" prop="contingentCondition">
              <el-input v-model="npfuturesOrderHisForm.contingentCondition" placeholder="请输入触发条件" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="止损价" prop="stopPrice">
              <el-input v-model="npfuturesOrderHisForm.stopPrice" placeholder="请输入止损价" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="强平原因" prop="forceCloseReason">
              <el-input v-model="npfuturesOrderHisForm.forceCloseReason" placeholder="请输入强平原因" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="自动挂起标志" prop="isAutoSuspend">
              <el-input v-model="npfuturesOrderHisForm.isAutoSuspend" placeholder="请输入自动挂起标志" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="业务单元" prop="businessUnit">
              <el-input v-model="npfuturesOrderHisForm.businessUnit" placeholder="请输入业务单元" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="请求编号" prop="requestID">
              <el-input v-model="npfuturesOrderHisForm.requestID" placeholder="请输入请求编号" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="本地报单编号" prop="orderLocalID">
              <el-input v-model="npfuturesOrderHisForm.orderLocalID" placeholder="请输入本地报单编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="交易所代码" prop="exchangeID">
              <el-input v-model="npfuturesOrderHisForm.exchangeID" placeholder="请输入交易所代码" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="会员代码" prop="participantID">
              <el-input v-model="npfuturesOrderHisForm.participantID" placeholder="请输入会员代码" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="客户代码" prop="clientID">
              <el-input v-model="npfuturesOrderHisForm.clientID" placeholder="请输入客户代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="合约在交易所的代码" prop="exchangeInstID">
              <el-input v-model="npfuturesOrderHisForm.exchangeInstID" placeholder="请输入合约在交易所的代码" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="交易所交易员代码" prop="traderID">
              <el-input v-model="npfuturesOrderHisForm.traderID" placeholder="请输入交易所交易员代码" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="安装编号" prop="installID">
              <el-input v-model="npfuturesOrderHisForm.installID" placeholder="请输入安装编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="报单提交状态" prop="orderSubmitStatus">
              <el-input v-model="npfuturesOrderHisForm.orderSubmitStatus" placeholder="请输入报单提交状态" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="报单提示序号" prop="notifySequence">
              <el-input v-model="npfuturesOrderHisForm.notifySequence" placeholder="请输入报单提示序号" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="交易日" prop="tradingDay">
              <el-input v-model="npfuturesOrderHisForm.tradingDay" placeholder="请输入交易日" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="结算编号" prop="settlementID">
              <el-input v-model="npfuturesOrderHisForm.settlementID" placeholder="请输入结算编号" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="报单编号" prop="orderSysID">
              <el-input v-model="npfuturesOrderHisForm.orderSysID" placeholder="请输入报单编号" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="报单来源" prop="orderSource">
              <el-input v-model="npfuturesOrderHisForm.orderSource" placeholder="请输入报单来源" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="报单状态" prop="orderStatus">
              <el-input v-model="npfuturesOrderHisForm.orderStatus" placeholder="请输入报单状态" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="报单类型" prop="orderType">
              <el-input v-model="npfuturesOrderHisForm.orderType" placeholder="请输入报单类型" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="今成交数量" prop="volumeTraded">
              <el-input v-model="npfuturesOrderHisForm.volumeTraded" placeholder="请输入今成交数量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span=8>
            <el-form-item label="剩余数量" prop="volumeTotal">
              <el-input v-model="npfuturesOrderHisForm.volumeTotal" placeholder="请输入剩余数量" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="报单日期" prop="insertDate">
              <el-input v-model="npfuturesOrderHisForm.insertDate" placeholder="请输入报单日期" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="委托时间" prop="insertTime">
              <el-input v-model="npfuturesOrderHisForm.insertTime" placeholder="请输入委托时间" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="激活时间" prop="activeTime">
              <el-input v-model="npfuturesOrderHisForm.activeTime" placeholder="请输入激活时间" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="挂起时间" prop="suspendTime">
              <el-input v-model="npfuturesOrderHisForm.suspendTime" placeholder="请输入挂起时间" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="最后修改时间" prop="updateTime">
              <el-input v-model="npfuturesOrderHisForm.updateTime" placeholder="请输入最后修改时间" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="撤销时间" prop="cancelTime">
              <el-input v-model="npfuturesOrderHisForm.cancelTime" placeholder="请输入撤销时间" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="最后修改交易所交易员代码" prop="activeTraderID">
              <el-input v-model="npfuturesOrderHisForm.activeTraderID" placeholder="请输入最后修改交易所交易员代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="结算会员编号" prop="clearingPartID">
              <el-input v-model="npfuturesOrderHisForm.clearingPartID" placeholder="请输入结算会员编号" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="序号" prop="sequenceNo">
              <el-input v-model="npfuturesOrderHisForm.sequenceNo" placeholder="请输入序号" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="前置编号" prop="frontID">
              <el-input v-model="npfuturesOrderHisForm.frontID" placeholder="请输入前置编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="会话编号" prop="sessionID">
              <el-input v-model="npfuturesOrderHisForm.sessionID" placeholder="请输入会话编号" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="用户端产品信息" prop="userProductInfo">
              <el-input v-model="npfuturesOrderHisForm.userProductInfo" placeholder="请输入用户端产品信息" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="状态信息" prop="statusMsg">
              <el-input v-model="npfuturesOrderHisForm.statusMsg" placeholder="请输入状态信息" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="用户强评标志" prop="userForceClose">
              <el-input v-model="npfuturesOrderHisForm.userForceClose" placeholder="请输入用户强评标志" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="操作用户代码" prop="activeUserID">
              <el-input v-model="npfuturesOrderHisForm.activeUserID" placeholder="请输入操作用户代码" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="经纪公司报单编号" prop="brokerOrderSeq">
              <el-input v-model="npfuturesOrderHisForm.brokerOrderSeq" placeholder="请输入经纪公司报单编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="相关报单" prop="relativeOrderSysID">
              <el-input v-model="npfuturesOrderHisForm.relativeOrderSysID" placeholder="请输入相关报单" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="郑商所成交数量" prop="zCETotalTradedVolume">
              <el-input v-model="npfuturesOrderHisForm.zCETotalTradedVolume" placeholder="请输入郑商所成交数量" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="互换单标志" prop="isSwapOrder">
              <el-input v-model="npfuturesOrderHisForm.isSwapOrder" placeholder="请输入互换单标志" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="营业部编号" prop="branchID">
              <el-input v-model="npfuturesOrderHisForm.branchID" placeholder="请输入营业部编号" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="投资单元代码" prop="investUnitID">
              <el-input v-model="npfuturesOrderHisForm.investUnitID" placeholder="请输入投资单元代码" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="币种代码" prop="currencyID">
              <el-input v-model="npfuturesOrderHisForm.currencyID" placeholder="请输入币种代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=8>
            <el-form-item label="IP地址" prop="iPAddress">
              <el-input v-model="npfuturesOrderHisForm.iPAddress" placeholder="请输入IP地址" />
            </el-form-item>
          </el-col>
          <el-col :span=8>
            <el-form-item label="Mac地址" prop="macAddress">
              <el-input v-model="npfuturesOrderHisForm.macAddress" placeholder="请输入Mac地址" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
  export default {
    name: 'NpfuturesOrderHisName',
    data() {
      return {
        npfuturesOrderHisLoading: true,
        npfuturesOrderHisDialog: false,
        npfuturesOrderHisData: [],
        orderPriceType: [],
        dicts: [],
        npfuturesOrderHisForm: {
          'id': '',
          'accountId': '',
          'brokerID': '',
          'investorID': '',
    ...
    methods: {
      ...
      doSearch: function(data, type) {
        ...
        this.npfuturesOrderHisLoading = true;
        this.$http({
          url: '/npfutures/npfuturesOrderHis/data',
          method: 'post',
          data: Object.assign(this.pageParams, this.searchForm)
        }).then(res => {
          if (res.code === 200) {
            this.npfuturesOrderHisData = res.rows;
            this.pageParams.totalPage = res.totalPage;
            this.pageParams.total = res.total;
            this.npfuturesOrderHisLoading = false;
          } else {
      ...
      dialogAdd: function() {
        ...
        this.npfuturesOrderHisDialog = true;
      },
      dialogEdit: function(row, column) {
        if (this.$refs.npfuturesOrderHisForm) {
          this.$refs.npfuturesOrderHisForm.resetFields();
        }
        this.$http({
          url: '/npfutures/npfuturesOrderHis/findBy',
          method: 'get',
          params: {
            'id': column.id
          }
      ...
      doSubmit: function(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$http({
              url: '/npfutures/npfuturesOrderHis/save',
              method: 'post',
              data: this.npfuturesOrderHisForm
            }).then(res => {
              if (res.code === 200) {
            ...
            this.npfuturesOrderHisDialog = false;
          }
        });
      },
      doDelete: function(row, column) {
        this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
          ...
          this.$http({
            url: '/npfutures/npfuturesOrderHis/del',
            method: 'post',
            data: {
              ids: column.id
            }

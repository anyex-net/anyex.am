<template>
  <div class="app-container">
    ...
    <el-table
      v-loading="npfuturesInvestorPositionLoading"
      :data="npfuturesInvestorPositionData"
    ...
    <el-dialog
      title="内盘期货持仓汇总表管理"
      :visible.sync="npfuturesInvestorPositionDialog"
      :close-on-click-modal="false"
      width="75%"
    >
      <el-form
        ref="npfuturesInvestorPositionForm"
        :model="npfuturesInvestorPositionForm"
        label-width="150px"
        class="npfuturesInvestorPositionForm"
      >
        <el-row>
          <el-col :span="8">
            <el-form-item label="AM平台账户ID" prop="accountId">
              <el-input v-model="npfuturesInvestorPositionForm.accountId" placeholder="请输入AM平台账户ID" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="合约代码" prop="instrumentID">
              <el-input v-model="npfuturesInvestorPositionForm.instrumentID" placeholder="请输入合约代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="经纪公司代码" prop="brokerID">
              <el-input v-model="npfuturesInvestorPositionForm.brokerID" placeholder="请输入经纪公司代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="投资者代码" prop="investorID">
              <el-input v-model="npfuturesInvestorPositionForm.investorID" placeholder="请输入投资者代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="持仓多空方向" prop="posiDirection">
              <el-select v-model="npfuturesInvestorPositionForm.posiDirection" placeholder="请输入持仓多空方向">
          ...
          <el-col :span="8">
            <el-form-item label="投机套保标志" prop="hedgeFlag">
              <el-select v-model="npfuturesInvestorPositionForm.hedgeFlag" placeholder="请输入投机套保标志">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="持仓日期" prop="positionDate">
              <el-input v-model="npfuturesInvestorPositionForm.positionDate" placeholder="请输入持仓日期">
          ...
          <el-col :span="8">
            <el-form-item label="上日持仓" prop="ydPosition">
              <el-input v-model="npfuturesInvestorPositionForm.ydPosition" placeholder="请输入上日持仓" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="今日持仓" prop="position">
              <el-input v-model="npfuturesInvestorPositionForm.position" placeholder="请输入今日持仓" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="多头冻结" prop="longFrozen">
              <el-input v-model="npfuturesInvestorPositionForm.longFrozen" placeholder="请输入多头冻结" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="空头冻结" prop="shortFrozen">
              <el-input v-model="npfuturesInvestorPositionForm.shortFrozen" placeholder="请输入空头冻结" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开仓冻结金额" prop="longFrozenAmount">
              <el-input v-model="npfuturesInvestorPositionForm.longFrozenAmount" placeholder="请输入开仓冻结金额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="开仓冻结金额" prop="shortFrozenAmount">
              <el-input v-model="npfuturesInvestorPositionForm.shortFrozenAmount" placeholder="请输入开仓冻结金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开仓量" prop="openVolume">
              <el-input v-model="npfuturesInvestorPositionForm.openVolume" placeholder="请输入开仓量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="平仓量" prop="closeVolume">
              <el-input v-model="npfuturesInvestorPositionForm.closeVolume" placeholder="请输入平仓量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="开仓金额" prop="openAmount">
              <el-input v-model="npfuturesInvestorPositionForm.openAmount" placeholder="请输入开仓金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="平仓金额" prop="closeAmount">
              <el-input v-model="npfuturesInvestorPositionForm.closeAmount" placeholder="请输入平仓金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="持仓成本" prop="positionCost">
              <el-input v-model="npfuturesInvestorPositionForm.positionCost" placeholder="请输入持仓成本" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上次占用的保证金" prop="preMargin">
              <el-input v-model="npfuturesInvestorPositionForm.preMargin" placeholder="请输入上次占用的保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="占用的保证金" prop="useMargin">
              <el-input v-model="npfuturesInvestorPositionForm.useMargin" placeholder="请输入占用的保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结的保证金" prop="frozenMargin">
              <el-input v-model="npfuturesInvestorPositionForm.frozenMargin" placeholder="请输入冻结的保证金" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="冻结的资金" prop="frozenCash">
              <el-input v-model="npfuturesInvestorPositionForm.frozenCash" placeholder="请输入冻结的资金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结的手续费" prop="frozenCommission">
              <el-input v-model="npfuturesInvestorPositionForm.frozenCommission" placeholder="请输入冻结的手续费" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="资金差额" prop="cashIn">
              <el-input v-model="npfuturesInvestorPositionForm.cashIn" placeholder="请输入资金差额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="手续费" prop="commission">
              <el-input v-model="npfuturesInvestorPositionForm.commission" placeholder="请输入手续费" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="手续费" prop="commission">
          ...
          <el-col :span="8">
            <el-form-item label="平仓盈亏" prop="closeProfit">
              <el-input v-model="npfuturesInvestorPositionForm.closeProfit" placeholder="请输入平仓盈亏" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="持仓盈亏" prop="positionProfit">
              <el-input v-model="npfuturesInvestorPositionForm.positionProfit" placeholder="请输入持仓盈亏" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上次结算价" prop="preSettlementPrice">
              <el-input v-model="npfuturesInvestorPositionForm.preSettlementPrice" placeholder="请输入上次结算价" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="本次结算价" prop="settlementPrice">
              <el-input v-model="npfuturesInvestorPositionForm.settlementPrice" placeholder="请输入本次结算价" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易日" prop="tradingDay">
              <el-input v-model="npfuturesInvestorPositionForm.tradingDay" placeholder="请输入交易日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="结算编号" prop="settlementID">
              <el-input v-model="npfuturesInvestorPositionForm.settlementID" placeholder="请输入结算编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开仓成本" prop="openCost">
              <el-input v-model="npfuturesInvestorPositionForm.openCost" placeholder="请输入开仓成本" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所保证金" prop="exchangeMargin">
              <el-input v-model="npfuturesInvestorPositionForm.exchangeMargin" placeholder="请输入交易所保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="组合成交形成的持仓" prop="combPosition">
              <el-input v-model="npfuturesInvestorPositionForm.combPosition" placeholder="请输入组合成交形成的持仓" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="组合多头冻结" prop="combLongFrozen">
              <el-input v-model="npfuturesInvestorPositionForm.combLongFrozen" placeholder="请输入组合多头冻结" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="组合空头冻结" prop="combShortFrozen">
              <el-input v-model="npfuturesInvestorPositionForm.combShortFrozen" placeholder="请输入组合空头冻结" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="逐日盯市平仓盈亏" prop="closeProfitByDate">
              <el-input v-model="npfuturesInvestorPositionForm.closeProfitByDate" placeholder="请输入逐日盯市平仓盈亏" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="逐笔对冲平仓盈亏" prop="closeProfitByTrade">
              <el-input v-model="npfuturesInvestorPositionForm.closeProfitByTrade" placeholder="请输入逐笔对冲平仓盈亏" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="今日持仓" prop="todayPosition">
              <el-input v-model="npfuturesInvestorPositionForm.todayPosition" placeholder="请输入今日持仓" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="保证金率" prop="marginRateByMoney">
              <el-input v-model="npfuturesInvestorPositionForm.marginRateByMoney" placeholder="请输入保证金率" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="保证金率(按手数)" prop="marginRateByVolume">
              <el-input v-model="npfuturesInvestorPositionForm.marginRateByVolume" placeholder="请输入保证金率(按手数)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="执行冻结" prop="strikeFrozen">
              <el-input v-model="npfuturesInvestorPositionForm.strikeFrozen" placeholder="请输入执行冻结" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="执行冻结金额" prop="strikeFrozenAmount">
              <el-input v-model="npfuturesInvestorPositionForm.strikeFrozenAmount" placeholder="请输入执行冻结金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="放弃执行冻结" prop="abandonFrozen">
              <el-input v-model="npfuturesInvestorPositionForm.abandonFrozen" placeholder="请输入放弃执行冻结" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所代码" prop="exchangeID">
              <el-input v-model="npfuturesInvestorPositionForm.exchangeID" placeholder="请输入交易所代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="执行冻结的昨仓" prop="ydStrikeFrozen">
              <el-input v-model="npfuturesInvestorPositionForm.ydStrikeFrozen" placeholder="请输入执行冻结的昨仓" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="投资单元代码" prop="investUnitID">
              <el-input v-model="npfuturesInvestorPositionForm.investUnitID" placeholder="请输入投资单元代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="大商所持仓成本差值，只有大商所使用" prop="positionCostOffset">
              <el-input v-model="npfuturesInvestorPositionForm.positionCostOffset" placeholder="请输入大商所持仓成本差值，只有大商所使用" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="tas持仓手数" prop="tasPosition">
              <el-input v-model="npfuturesInvestorPositionForm.tasPosition" placeholder="请输入tas持仓手数" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="tas持仓手数" prop="tasPosition">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="tas持仓成本" prop="tasPositionCost">
              <el-input v-model="npfuturesInvestorPositionForm.tasPositionCost" placeholder="请输入tas持仓成本" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
export default {
  name: 'NpfuturesInvestorPositionName',
  data() {
    return {
      npfuturesInvestorPositionLoading: true,
      npfuturesInvestorPositionDialog: false,
      npfuturesInvestorPositionData: [],
      posiDirection: [],
      hedgeFlag: [],
      positionDate: [],
      dicts: [],
      npfuturesInvestorPositionForm: {
        'id': '',
        'accountId': '',
        'instrumentID': '',
        'brokerID': '',
  ...
  methods: {
    ...
    doSearch: function(data, type) {
      ...
      this.npfuturesInvestorPositionLoading = true;
      this.$http({
        url: '/npfutures/npfuturesInvestorPosition/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.npfuturesInvestorPositionData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.npfuturesInvestorPositionLoading = false;
        } else {
    ...
    dialogAdd: function() {
      this.npfuturesInvestorPositionForm = {
        'id': '',
        'accountId': '',
        'instrumentID': '',
        'brokerID': '',
      ...
      this.npfuturesInvestorPositionDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.npfuturesInvestorPositionForm) {
        this.$refs.npfuturesInvestorPositionForm.resetFields();
      }
      this.$http({
        url: '/npfutures/npfuturesInvestorPosition/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/npfutures/npfuturesInvestorPosition/save',
            method: 'post',
            data: this.npfuturesInvestorPositionForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.npfuturesInvestorPositionDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/npfutures/npfuturesInvestorPosition/del',
          method: 'post',
          data: {
            ids: column.id
          }

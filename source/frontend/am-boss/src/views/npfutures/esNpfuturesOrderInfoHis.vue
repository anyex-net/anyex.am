<template>
  <div class="app-container">
    ...
    <el-table v-loading="esNpfuturesOrderInfoHisLoading" :data="esNpfuturesOrderInfoHisData"
      ...
      <el-table-column prop="serverFlag" label="服务器标识"/>
    ...
    />
    <el-dialog title="内盘期货委托订单历史表管理" :visible.sync="esNpfuturesOrderInfoHisDialog" :close-on-click-modal="false"
               width="600">
      <el-form ref="esNpfuturesOrderInfoHisForm" :model="esNpfuturesOrderInfoHisForm"
               :rules="esNpfuturesOrderInfoHisRules" label-width="150px" class="esNpfuturesOrderInfoHisForm">
        <el-row>
          <el-col :span="8">
            <el-form-item label="AM平台账户ID" prop="accountId">
              <el-input v-model="esNpfuturesOrderInfoHisForm.accountId" placeholder="请输入AM平台账户ID"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="经纪商编码" prop="brokerNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.brokerNo" placeholder="请输入经纪商编码"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="客户资金帐号" prop="accountNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.accountNo" placeholder="请输入客户资金帐号"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所编号" prop="exchangeNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.exchangeNo" placeholder="请输入交易所编号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="品种类型" prop="commodityType">
              <el-input v-model="esNpfuturesOrderInfoHisForm.commodityType" placeholder="请输入品种类型"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="品种编码类型" prop="commodityNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.commodityNo" placeholder="请输入品种编码类型"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="合约1" prop="contractNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.contractNo" placeholder="请输入合约1"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="执行价格1" prop="strikePrice">
              <el-input v-model="esNpfuturesOrderInfoHisForm.strikePrice" placeholder="请输入执行价格1"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="看张看跌1" prop="callOrPutFlag">
              <el-input v-model="esNpfuturesOrderInfoHisForm.callOrPutFlag" placeholder="请输入看张看跌1"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="合约2" prop="contractNo2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.contractNo2" placeholder="请输入合约2"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="执行价格2" prop="strikePrice2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.strikePrice2" placeholder="请输入执行价格2"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="看张看跌2" prop="callOrPutFlag2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.callOrPutFlag2" placeholder="请输入看张看跌2"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="委托类型" prop="orderType">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderType" placeholder="请输入委托类型"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托来源" prop="orderSource">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderSource" placeholder="请输入委托来源"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托有效类型" prop="timeInForce">
              <el-input v-model="esNpfuturesOrderInfoHisForm.timeInForce" placeholder="请输入委托有效类型"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="有效日期(GTD情况下使用)" prop="expireTime">
              <el-input v-model="esNpfuturesOrderInfoHisForm.expireTime" placeholder="请输入有效日期(GTD情况下使用)"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否风险报单" prop="isRiskOrder">
              <el-input v-model="esNpfuturesOrderInfoHisForm.isRiskOrder" placeholder="请输入是否风险报单"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="买入卖出" prop="orderSide">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderSide" placeholder="请输入买入卖出"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="开平标志1" prop="positionEffect">
              <el-input v-model="esNpfuturesOrderInfoHisForm.positionEffect" placeholder="请输入开平标志1"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开平标志2" prop="positionEffect2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.positionEffect2" placeholder="请输入开平标志2"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="询价号" prop="inquiryNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.inquiryNo" placeholder="请输入询价号"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="投机保值" prop="hedgeFlag">
              <el-input v-model="esNpfuturesOrderInfoHisForm.hedgeFlag" placeholder="请输入投机保值"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托价格1" prop="orderPrice">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderPrice" placeholder="请输入委托价格1"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托价格2，做市商应价使用" prop="orderPrice2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderPrice2" placeholder="请输入委托价格2，做市商应价使用"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="触发价格" prop="stopPrice">
              <el-input v-model="esNpfuturesOrderInfoHisForm.stopPrice" placeholder="请输入触发价格"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托数量" prop="orderQty">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderQty" placeholder="请输入委托数量"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="最小成交量" prop="orderMinQty">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderMinQty" placeholder="请输入最小成交量"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="撤单数量" prop="orderCanceledQty">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderCanceledQty" placeholder="请输入撤单数量"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冰山单最小随机量" prop="minClipSize">
              <el-input v-model="esNpfuturesOrderInfoHisForm.minClipSize" placeholder="请输入冰山单最小随机量"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冰山单最大随机量" prop="maxClipSize">
              <el-input v-model="esNpfuturesOrderInfoHisForm.maxClipSize" placeholder="请输入冰山单最大随机量"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="软件授权号" prop="licenseNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.licenseNo" placeholder="请输入软件授权号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="整型参考值" prop="refInt">
              <el-input v-model="esNpfuturesOrderInfoHisForm.refInt" placeholder="请输入整型参考值"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="字符串参考值" prop="refString">
              <el-input v-model="esNpfuturesOrderInfoHisForm.refString" placeholder="请输入字符串参考值"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上级资金账号" prop="parentAccountNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.parentAccountNo" placeholder="请输入上级资金账号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="服务器标识" prop="serverFlag">
              <el-input v-model="esNpfuturesOrderInfoHisForm.serverFlag" placeholder="请输入服务器标识"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托编码" prop="orderNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderNo" placeholder="请输入委托编码"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="客户端本地委托编号" prop="clientOrderNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.clientOrderNo" placeholder="请输入客户端本地委托编号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="本地号" prop="orderLocalNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderLocalNo" placeholder="请输入本地号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="系统号" prop="orderSystemNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderSystemNo" placeholder="请输入系统号"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所系统号" prop="orderExchangeSystemNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderExchangeSystemNo" placeholder="请输入交易所系统号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="父单号" prop="orderParentNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderParentNo" placeholder="请输入父单号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="父单系统号" prop="orderParentSystemNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderParentSystemNo" placeholder="请输入父单系统号"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易编码" prop="tradeNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.tradeNo" placeholder="请输入交易编码"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上手号" prop="upperNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.upperNo" placeholder="请输入上手号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上手通道号" prop="upperChannelNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.upperChannelNo" placeholder="请输入上手通道号"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="会员号和清算号" prop="upperSettleNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.upperSettleNo" placeholder="请输入会员号和清算号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上手登录号" prop="upperUserNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.upperUserNo" placeholder="请输入上手登录号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="下单人" prop="orderInsertUserNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderInsertUserNo" placeholder="请输入下单人"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="下单时间" prop="orderInsertTime">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderInsertTime" placeholder="请输入下单时间"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="录单操作人" prop="orderCommandUserNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderCommandUserNo" placeholder="请输入录单操作人"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托更新人" prop="orderUpdateUserNo">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderUpdateUserNo" placeholder="请输入委托更新人"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="委托更新时间" prop="orderUpdateTime">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderUpdateTime" placeholder="请输入委托更新时间"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托状态" prop="orderState">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderState" placeholder="请输入委托状态"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="成交价1" prop="orderMatchPrice">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderMatchPrice" placeholder="请输入成交价1"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="成交价2" prop="orderMatchPrice2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderMatchPrice2" placeholder="请输入成交价2"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="成交量1" prop="orderMatchQty">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderMatchQty" placeholder="请输入成交量1"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="成交量2" prop="orderMatchQty2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderMatchQty2" placeholder="请输入成交量2"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="最后一次操作错误信息码" prop="errorCode">
              <el-input v-model="esNpfuturesOrderInfoHisForm.errorCode" placeholder="请输入最后一次操作错误信息码"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="错误信息" prop="errorText">
              <el-input v-model="esNpfuturesOrderInfoHisForm.errorText" placeholder="请输入错误信息"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否为录入委托单" prop="isBackInput">
              <el-input v-model="esNpfuturesOrderInfoHisForm.isBackInput" placeholder="请输入是否为录入委托单"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="委托成交删除标" prop="isDeleted">
              <el-input v-model="esNpfuturesOrderInfoHisForm.isDeleted" placeholder="请输入委托成交删除标"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否为T+1单" prop="isAddOne">
              <el-input v-model="esNpfuturesOrderInfoHisForm.isAddOne" placeholder="请输入是否为T+1单"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托流水号" prop="orderStreamID">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderStreamID" placeholder="请输入委托流水号"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上手流号" prop="upperStreamID">
              <el-input v-model="esNpfuturesOrderInfoHisForm.upperStreamID" placeholder="请输入上手流号"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="每手乘数，计算参数" prop="contractSize">
              <el-input v-model="esNpfuturesOrderInfoHisForm.contractSize" placeholder="请输入每手乘数，计算参数"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="每手乘数，计算参数" prop="contractSize2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.contractSize2" placeholder="请输入每手乘数，计算参数"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="品种币种组" prop="commodityCurrencyGroup">
              <el-input v-model="esNpfuturesOrderInfoHisForm.commodityCurrencyGroup" placeholder="请输入品种币种组"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="品种币种" prop="commodityCurrency">
              <el-input v-model="esNpfuturesOrderInfoHisForm.commodityCurrency" placeholder="请输入品种币种"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="手续费计算方式" prop="feeMode">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeMode" placeholder="请输入手续费计算方式"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="手续费参数值 冻结手续费均按照开仓手续费计算" prop="feeParam">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeParam" placeholder="请输入手续费参数值 冻结手续费均按照开仓手续费计算"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="客户手续费币种组" prop="feeCurrencyGroup">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeCurrencyGroup" placeholder="请输入客户手续费币种组"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="客户手续费币种" prop="feeCurrency">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeCurrency" placeholder="请输入客户手续费币种"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="手续费计算方式" prop="feeMode2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeMode2" placeholder="请输入手续费计算方式"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="手续费参数值 冻结手续费均按照开仓手续费计算" prop="feeParam2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeParam2" placeholder="请输入手续费参数值 冻结手续费均按照开仓手续费计算"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="客户手续费币种组" prop="feeCurrencyGroup2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeCurrencyGroup2" placeholder="请输入客户手续费币种组"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="客户手续费币种" prop="feeCurrency2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeCurrency2" placeholder="请输入客户手续费币种"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="保证金计算方式" prop="marginMode">
              <el-input v-model="esNpfuturesOrderInfoHisForm.marginMode" placeholder="请输入保证金计算方式"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="保证金参数值" prop="marginParam">
              <el-input v-model="esNpfuturesOrderInfoHisForm.marginParam" placeholder="请输入保证金参数值"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="保证金计算方式" prop="marginMode2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.marginMode2" placeholder="请输入保证金计算方式"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="保证金参数值" prop="marginParam2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.marginParam2" placeholder="请输入保证金参数值"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="昨结算价  比例方式的市价单和组合订单使用" prop="preSettlePrice">
              <el-input v-model="esNpfuturesOrderInfoHisForm.preSettlePrice" placeholder="请输入昨结算价  比例方式的市价单和组合订单使用"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="昨结算价  比例方式的市价单和组合订单使用" prop="preSettlePrice2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.preSettlePrice2" placeholder="请输入昨结算价  比例方式的市价单和组合订单使用"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="预开仓数量 委托数量中的开仓部分" prop="openVol">
              <el-input v-model="esNpfuturesOrderInfoHisForm.openVol" placeholder="请输入预开仓数量 委托数量中的开仓部分"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="预平仓数量 委托数量中的平仓部分" prop="coverVol">
              <el-input v-model="esNpfuturesOrderInfoHisForm.coverVol" placeholder="请输入预平仓数量 委托数量中的平仓部分"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="预开仓数量 委托数量中的开仓部分" prop="openVol2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.openVol2" placeholder="请输入预开仓数量 委托数量中的开仓部分"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="预平仓数量 委托数量中的平仓部分" prop="coverVol2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.coverVol2" placeholder="请输入预平仓数量 委托数量中的平仓部分"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结手续费" prop="feeValue">
              <el-input v-model="esNpfuturesOrderInfoHisForm.feeValue" placeholder="请输入冻结手续费"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="冻结保证金 合并计算的此项为0" prop="marginValue">
              <el-input v-model="esNpfuturesOrderInfoHisForm.marginValue" placeholder="请输入冻结保证金 合并计算的此项为0"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="策略单类型" prop="tacticsType">
              <el-input v-model="esNpfuturesOrderInfoHisForm.tacticsType" placeholder="请输入策略单类型"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="触发条件" prop="triggerCondition">
              <el-input v-model="esNpfuturesOrderInfoHisForm.triggerCondition" placeholder="请输入触发条件"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="触发价格类型" prop="triggerPriceType">
              <el-input v-model="esNpfuturesOrderInfoHisForm.triggerPriceType" placeholder="请输入触发价格类型"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否T+1有效" prop="addOneIsValid">
              <el-input v-model="esNpfuturesOrderInfoHisForm.addOneIsValid" placeholder="请输入是否T+1有效"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托数量2" prop="orderQty2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderQty2" placeholder="请输入委托数量2"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="投机保值2" prop="hedgeFlag2">
              <el-input v-model="esNpfuturesOrderInfoHisForm.hedgeFlag2" placeholder="请输入投机保值2"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="市价撮合深度" prop="marketLevel">
              <el-input v-model="esNpfuturesOrderInfoHisForm.marketLevel" placeholder="请输入市价撮合深度"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="心跳检测失败时，服务器自动撤单标识" prop="orderDeleteByDisConnFlag">
              <el-input v-model="esNpfuturesOrderInfoHisForm.orderDeleteByDisConnFlag" placeholder="请输入心跳检测失败时，服务器自动撤单标识"/>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
  export default {
    name: 'EsNpfuturesOrderInfoHisName',
    data() {
      return {
        esNpfuturesOrderInfoHisLoading: true,
        esNpfuturesOrderInfoHisDialog: false,
        esNpfuturesOrderInfoHisData: [],
        commodityTypeSelects: [],
        dicts: [],
        esNpfuturesOrderInfoHisForm: {
          'id': '',
          'accountId': '',
          'brokerNo': '',
          'accountNo': '',
    ...
    methods: {
      ...
      doSearch: function(data, type) {
        ...
        this.esNpfuturesOrderInfoHisLoading = true;
        this.$http({
          url: '/npfutures/esNpfuturesOrderInfoHis/data',
          method: 'post',
          data: Object.assign(this.pageParams, this.searchForm)
        }).then(res => {
          if (res.code === 200) {
            this.esNpfuturesOrderInfoHisData = res.rows;
            this.pageParams.totalPage = res.totalPage;
            this.pageParams.total = res.total;
            this.esNpfuturesOrderInfoHisLoading = false;
          } else {
      ...
      dialogAdd: function() {
        this.esNpfuturesOrderInfoHisForm = {
          'id': '',
          'accountId': '',
          'brokerNo': '',
          'accountNo': '',
        ...
        this.esNpfuturesOrderInfoHisDialog = true;
      },
      dialogEdit: function(row, column) {
        if (this.$refs.esNpfuturesOrderInfoHisForm) {
          this.$refs.esNpfuturesOrderInfoHisForm.resetFields();
        }
        this.$http({
          url: '/npfutures/esNpfuturesOrderInfoHis/findBy',
          method: 'get',
          params: {
            'id': column.id
          }
      ...
      doSubmit: function(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$http({
              url: '/npfutures/esNpfuturesOrderInfoHis/save',
              method: 'post',
              data: this.esNpfuturesOrderInfoHisForm
            }).then(res => {
              if (res.code === 200) {
            ...
            this.esNpfuturesOrderInfoHisDialog = false;
          }
        });
      },
      doDelete: function(row, column) {
        this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
          ...
          this.$http({
            url: '/npfutures/esNpfuturesOrderInfoHis/del',
            method: 'post',
            data: {
              ids: column.id
            }

<template>
  <div class="app-container">
    ...
    <el-table
      v-loading="npfuturesTradingAccountLoading"
      :data="npfuturesTradingAccountData"
    ...
    <el-dialog
      title="内盘期货资金账户息表管理"
      :visible.sync="npfuturesTradingAccountDialog"
      :close-on-click-modal="false"
      width="75%"
    >
      <el-form
        ref="npfuturesTradingAccountForm"
        :model="npfuturesTradingAccountForm"
        label-width="150px"
        class="npfuturesTradingAccountForm"
      >
        <el-row>
          <el-col :span="8">
            <el-form-item label="AM平台账户ID" prop="accountId">
              <el-input v-model="npfuturesTradingAccountForm.accountId" placeholder="请输入AM平台账户ID" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="经纪公司代码" prop="brokerID">
              <el-input v-model="npfuturesTradingAccountForm.brokerID" placeholder="请输入经纪公司代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="投资者帐号(对应CTP中AccountID)" prop="investorID">
              <el-input v-model="npfuturesTradingAccountForm.investorID" placeholder="请输入投资者帐号(对应CTP中AccountID)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上次质押金额" prop="preMortgage">
              <el-input v-model="npfuturesTradingAccountForm.preMortgage" placeholder="请输入上次质押金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上次信用额度" prop="preCredit">
              <el-input v-model="npfuturesTradingAccountForm.preCredit" placeholder="请输入上次信用额度" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上次存款额" prop="preDeposit">
              <el-input v-model="npfuturesTradingAccountForm.preDeposit" placeholder="请输入上次存款额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上次结算准备金" prop="preBalance">
              <el-input v-model="npfuturesTradingAccountForm.preBalance" placeholder="请输入上次结算准备金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上次占用的保证金" prop="preMargin">
              <el-input v-model="npfuturesTradingAccountForm.preMargin" placeholder="请输入上次占用的保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="利息基数" prop="interestBase">
              <el-input v-model="npfuturesTradingAccountForm.interestBase" placeholder="请输入利息基数" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="利息收入" prop="interest">
              <el-input v-model="npfuturesTradingAccountForm.interest" placeholder="请输入利息收入" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="入金金额" prop="deposit">
              <el-input v-model="npfuturesTradingAccountForm.deposit" placeholder="请输入入金金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="出金金额" prop="withdraw">
              <el-input v-model="npfuturesTradingAccountForm.withdraw" placeholder="请输入出金金额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="冻结的保证金" prop="frozenMargin">
              <el-input v-model="npfuturesTradingAccountForm.frozenMargin" placeholder="请输入冻结的保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结的资金" prop="frozenCash">
              <el-input v-model="npfuturesTradingAccountForm.frozenCash" placeholder="请输入冻结的资金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结的手续费" prop="frozenCommission">
              <el-input v-model="npfuturesTradingAccountForm.frozenCommission" placeholder="请输入冻结的手续费" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="当前保证金总额" prop="currMargin">
              <el-input v-model="npfuturesTradingAccountForm.currMargin" placeholder="请输入当前保证金总额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="资金差额" prop="cashIn">
              <el-input v-model="npfuturesTradingAccountForm.cashIn" placeholder="请输入资金差额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="手续费" prop="commission">
              <el-input v-model="npfuturesTradingAccountForm.commission" placeholder="请输入手续费" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="平仓盈亏" prop="closeProfit">
              <el-input v-model="npfuturesTradingAccountForm.closeProfit" placeholder="请输入平仓盈亏" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="持仓盈亏" prop="positionProfit">
              <el-input v-model="npfuturesTradingAccountForm.positionProfit" placeholder="请输入持仓盈亏" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="期货结算准备金" prop="balance">
              <el-input v-model="npfuturesTradingAccountForm.balance" placeholder="请输入期货结算准备金" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="可用资金" prop="available">
              <el-input v-model="npfuturesTradingAccountForm.available" placeholder="请输入可用资金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="可取资金" prop="withdrawQuota">
              <el-input v-model="npfuturesTradingAccountForm.withdrawQuota" placeholder="请输入可取资金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="基本准备金" prop="reserve">
              <el-input v-model="npfuturesTradingAccountForm.reserve" placeholder="请输入基本准备金" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易日" prop="tradingDay">
              <el-input v-model="npfuturesTradingAccountForm.tradingDay" placeholder="请输入交易日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="结算编号" prop="settlementID">
              <el-input v-model="npfuturesTradingAccountForm.settlementID" placeholder="请输入结算编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="信用额度" prop="credit">
              <el-input v-model="npfuturesTradingAccountForm.credit" placeholder="请输入信用额度" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="质押金额" prop="mortgage">
              <el-input v-model="npfuturesTradingAccountForm.mortgage" placeholder="请输入质押金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所保证金" prop="exchangeMargin">
              <el-input v-model="npfuturesTradingAccountForm.exchangeMargin" placeholder="请输入交易所保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="投资者交割保证金" prop="deliveryMargin">
              <el-input v-model="npfuturesTradingAccountForm.deliveryMargin" placeholder="请输入投资者交割保证金" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所交割保证金" prop="exchangeDeliveryMargin">
              <el-input v-model="npfuturesTradingAccountForm.exchangeDeliveryMargin" placeholder="请输入交易所交割保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="保底期货结算准备金" prop="reserveBalance">
              <el-input v-model="npfuturesTradingAccountForm.reserveBalance" placeholder="请输入保底期货结算准备金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="币种代码" prop="currencyID">
              <el-input v-model="npfuturesTradingAccountForm.currencyID" placeholder="请输入币种代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上次货币质入金额" prop="preFundMortgageIn">
              <el-input v-model="npfuturesTradingAccountForm.preFundMortgageIn" placeholder="请输入上次货币质入金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上次货币质出金额" prop="preFundMortgageOut">
              <el-input v-model="npfuturesTradingAccountForm.preFundMortgageOut" placeholder="请输入上次货币质出金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="货币质出金额" prop="fundMortgageOut">
              <el-input v-model="npfuturesTradingAccountForm.fundMortgageOut" placeholder="请输入货币质出金额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="货币质押余额" prop="fundMortgageAvailable">
              <el-input v-model="npfuturesTradingAccountForm.fundMortgageAvailable" placeholder="请输入货币质押余额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="可质押货币金额" prop="mortgageableFund">
              <el-input v-model="npfuturesTradingAccountForm.mortgageableFund" placeholder="请输入可质押货币金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="特殊产品占用保证金" prop="specProductMargin">
              <el-input v-model="npfuturesTradingAccountForm.specProductMargin" placeholder="请输入特殊产品占用保证金" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="特殊产品冻结保证金" prop="specProductFrozenMargin">
              <el-input v-model="npfuturesTradingAccountForm.specProductFrozenMargin" placeholder="请输入特殊产品冻结保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="特殊产品手续费" prop="specProductCommission">
              <el-input v-model="npfuturesTradingAccountForm.specProductCommission" placeholder="请输入特殊产品手续费" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="特殊产品冻结手续费" prop="specProductFrozenCommission">
              <el-input v-model="npfuturesTradingAccountForm.specProductFrozenCommission" placeholder="请输入特殊产品冻结手续费" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="特殊产品持仓盈亏" prop="specProductPositionProfit">
              <el-input v-model="npfuturesTradingAccountForm.specProductPositionProfit" placeholder="请输入特殊产品持仓盈亏" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="特殊产品平仓盈亏" prop="specProductCloseProfit">
              <el-input v-model="npfuturesTradingAccountForm.specProductCloseProfit" placeholder="请输入特殊产品平仓盈亏" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="根据持仓盈亏算法计算的特殊产品持仓盈亏" prop="specProductPositionProfitByAlg">
              <el-input
                v-model="npfuturesTradingAccountForm.specProductPositionProfitByAlg"
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="特殊产品交易所保证金" prop="specProductExchangeMargin">
              <el-input v-model="npfuturesTradingAccountForm.specProductExchangeMargin" placeholder="请输入特殊产品交易所保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="业务类型" prop="bizType">
              <el-select v-model="npfuturesTradingAccountForm.bizType" placeholder="请输入业务类型">
          ...
          <el-col :span="8">
            <el-form-item label="延时换汇冻结金额" prop="frozenSwap">
              <el-input v-model="npfuturesTradingAccountForm.frozenSwap" placeholder="请输入延时换汇冻结金额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="剩余换汇额度" prop="remainSwap">
              <el-input v-model="npfuturesTradingAccountForm.remainSwap" placeholder="请输入剩余换汇额度" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
export default {
  name: 'NpfuturesTradingAccountName',
  data() {
    return {
      npfuturesTradingAccountLoading: true,
      npfuturesTradingAccountDialog: false,
      npfuturesTradingAccountData: [],
      bizType: [],
      dicts: [],
      npfuturesTradingAccountForm: {
        'id': '',
        'accountId': '',
        'brokerID': '',
        'investorID': '',
  ...
  methods: {
    ...
    doSearch: function(data, type) {
      ...
      this.npfuturesTradingAccountLoading = true;
      this.$http({
        url: '/npfutures/npfuturesTradingAccount/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.npfuturesTradingAccountData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.npfuturesTradingAccountLoading = false;
        } else {
    ...
    dialogAdd: function() {
      this.npfuturesTradingAccountForm = {
        'id': '',
        'accountId': '',
        'brokerID': '',
        'investorID': '',
      ...
      this.npfuturesTradingAccountDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.npfuturesTradingAccountForm) {
        this.$refs.npfuturesTradingAccountForm.resetFields();
      }
      this.$http({
        url: '/npfutures/npfuturesTradingAccount/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/npfutures/npfuturesTradingAccount/save',
            method: 'post',
            data: this.npfuturesTradingAccountForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.npfuturesTradingAccountDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/npfutures/npfuturesTradingAccount/del',
          method: 'post',
          data: {
            ids: column.id
          }

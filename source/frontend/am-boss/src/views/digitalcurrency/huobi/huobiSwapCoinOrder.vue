<template>
  <div class="app-container">
    ...
    <el-table v-loading="huobiSwapCoinOrderLoading" :data="huobiSwapCoinOrderData"
    ...
    />
    <el-dialog title="永续合约账户订单信息管理" :visible.sync="huobiSwapCoinOrderDialog" :close-on-click-modal="false" width="600">
      <el-form ref="huobiSwapCoinOrderForm" :model="huobiSwapCoinOrderForm" :rules="huobiSwapCoinOrderRules"
               label-width="150px" class="huobiSwapCoinOrderForm">
        <el-form-item label="主键" prop="id">
          <el-input v-model="huobiSwapCoinOrderForm.id" placeholder="请输入主键"/>
        </el-form-item>
        <el-form-item label="平台账户ID" prop="accountId">
          <el-input v-model="huobiSwapCoinOrderForm.accountId" placeholder="请输入平台账户ID"/>
        </el-form-item>
        <el-form-item label="外部平台apikey" prop="apiKey">
          <el-input v-model="huobiSwapCoinOrderForm.apiKey" placeholder="请输入外部平台apikey"/>
        </el-form-item>
        <el-form-item label="品种代码" prop="symbol">
          <el-input v-model="huobiSwapCoinOrderForm.symbol" placeholder="请输入品种代码"/>
        </el-form-item>
        <el-form-item label="合约类型" prop="contractType">
          <el-input v-model="huobiSwapCoinOrderForm.contractType" placeholder="请输入合约类型"/>
        </el-form-item>
        <el-form-item label="合约代码" prop="contractCode">
          <el-input v-model="huobiSwapCoinOrderForm.contractCode" placeholder="请输入合约代码"/>
        </el-form-item>
        <el-form-item label="委托数量" prop="volume">
          <el-input v-model="huobiSwapCoinOrderForm.volume" placeholder="请输入委托数量"/>
        </el-form-item>
        <el-form-item label="委托价格" prop="price">
          <el-input v-model="huobiSwapCoinOrderForm.price" placeholder="请输入委托价格"/>
        </el-form-item>
        <el-form-item label="订单报价类型" prop="orderPriceType">
          <el-input v-model="huobiSwapCoinOrderForm.orderPriceType" placeholder="请输入订单报价类型"/>
        </el-form-item>
        <el-form-item label="买卖方向" prop="direction">
          <el-input v-model="huobiSwapCoinOrderForm.direction" placeholder="请输入买卖方向"/>
        </el-form-item>
        <el-form-item label="开平方向" prop="offset">
          <el-input v-model="huobiSwapCoinOrderForm.offset" placeholder="请输入开平方向"/>
        </el-form-item>
        <el-form-item label="杠杆倍数" prop="leverRate">
          <el-input v-model="huobiSwapCoinOrderForm.leverRate" placeholder="请输入杠杆倍数"/>
        </el-form-item>
        <el-form-item label="订单ID" prop="orderId">
          <el-input v-model="huobiSwapCoinOrderForm.orderId" placeholder="请输入订单ID"/>
        </el-form-item>
        <el-form-item label="订单ID" prop="orderIdStr">
          <el-input v-model="huobiSwapCoinOrderForm.orderIdStr" placeholder="请输入订单ID"/>
        </el-form-item>
        <el-form-item label="客户订单ID" prop="clientOrderId">
          <el-input v-model="huobiSwapCoinOrderForm.clientOrderId" placeholder="请输入客户订单ID"/>
        </el-form-item>
        <el-form-item label="创建时间" prop="createdAt">
          <el-input v-model="huobiSwapCoinOrderForm.createdAt" placeholder="请输入创建时间"/>
        </el-form-item>
        <el-form-item label="撤单时间" prop="canceledAt">
          <el-input v-model="huobiSwapCoinOrderForm.canceledAt" placeholder="请输入撤单时间"/>
        </el-form-item>
        <el-form-item label="成交数量" prop="tradeVolume">
          <el-input v-model="huobiSwapCoinOrderForm.tradeVolume" placeholder="请输入成交数量"/>
        </el-form-item>
        <el-form-item label="成交总金额" prop="tradeTurnover">
          <el-input v-model="huobiSwapCoinOrderForm.tradeTurnover" placeholder="请输入成交总金额"/>
        </el-form-item>
        <el-form-item label="手续费" prop="fee">
          <el-input v-model="huobiSwapCoinOrderForm.fee" placeholder="请输入手续费"/>
        </el-form-item>
        <el-form-item label="成交均价" prop="tradeAvgPrice">
          <el-input v-model="huobiSwapCoinOrderForm.tradeAvgPrice" placeholder="请输入成交均价"/>
        </el-form-item>
        <el-form-item label="冻结保证金" prop="marginFrozen">
          <el-input v-model="huobiSwapCoinOrderForm.marginFrozen" placeholder="请输入冻结保证金"/>
        </el-form-item>
        <el-form-item label="平仓盈亏" prop="profit">
          <el-input v-model="huobiSwapCoinOrderForm.profit" placeholder="请输入平仓盈亏"/>
        </el-form-item>
        <el-form-item label="订单状态" prop="status">
          <el-input v-model="huobiSwapCoinOrderForm.status" placeholder="请输入订单状态"/>
        </el-form-item>
        <el-form-item label="订单类型" prop="orderType">
          <el-input v-model="huobiSwapCoinOrderForm.orderType" placeholder="请输入订单类型"/>
        </el-form-item>
        <el-form-item label="订单来源" prop="orderSource">
          <el-input v-model="huobiSwapCoinOrderForm.orderSource" placeholder="请输入订单来源"/>
        </el-form-item>
        <el-form-item label="手续费币种" prop="feeAsset">
          <el-input v-model="huobiSwapCoinOrderForm.feeAsset" placeholder="请输入手续费币种"/>
        </el-form-item>
        <el-form-item label="强平类型" prop="liquidationType">
          <el-input v-model="huobiSwapCoinOrderForm.liquidationType" placeholder="请输入强平类型"/>
        </el-form-item>
        <el-form-item label="是否设置止盈止损" prop="isTpsl">
          <el-input v-model="huobiSwapCoinOrderForm.isTpsl" placeholder="请输入是否设置止盈止损"/>
        </el-form-item>
        <el-form-item label="真实收益" prop="realProfit">
          <el-input v-model="huobiSwapCoinOrderForm.realProfit" placeholder="请输入真实收益"/>
        </el-form-item>
        <el-form-item>
          <el-button type="success" @click="doSubmit('huobiSwapCoinOrderForm')">提交</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
...
<script>
  export default {
    name: 'HuobiSwapCoinOrderName',
    data() {
      return {
        huobiSwapCoinOrderLoading: true,
        huobiSwapCoinOrderDialog: false,
        huobiSwapCoinOrderData: [],
        commodityTypeSelects: [],
        dicts: [],
        huobiSwapCoinOrderForm: {
          'id': '',
          'accountId': '',
          'apiKey': '',
          'symbol': '',
    ...
    methods: {
      ...
      doInitData() {
        this.$http({
          url: '/digitalcurrency/huobi/dict/huobiSwapCoinOrder',
          method: 'get'
        }).then(res => {
          if (res.code === 200) {
      ...
      doSearch: function(data, type) {
        ...
        this.huobiSwapCoinOrderLoading = true;
        this.$http({
          url: '/digitalcurrency/huobi/huobiSwapCoinOrder/data',
          method: 'post',
          data: Object.assign(this.pageParams, this.searchForm)
        }).then(res => {
          if (res.code === 200) {
            this.huobiSwapCoinOrderData = res.rows;
            this.pageParams.totalPage = res.totalPage;
            this.pageParams.total = res.total;
            this.huobiSwapCoinOrderLoading = false;
          } else {
      ...
      dialogAdd: function() {
        ...
        this.huobiSwapCoinOrderDialog = true;
      },
      dialogEdit: function(row, column) {
        if (this.$refs.huobiSwapCoinOrderForm) {
          this.$refs.huobiSwapCoinOrderForm.resetFields();
        }
        this.$http({
          url: '/digitalcurrency/huobi/huobiSwapCoinOrder/findBy',
          method: 'get',
          params: {
            'id': column.id
          }
      ...
      doSubmit: function(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$http({
              url: '/digitalcurrency/huobi/huobiSwapCoinOrder/save',
              method: 'post',
              data: this.huobiSwapCoinOrderForm
            }).then(res => {
              if (res.code === 200) {
            ...
            this.huobiSwapCoinOrderDialog = false;
          }
        });
      },
      doDelete: function(row, column) {
        this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
          ...
          this.$http({
            url: '/digitalcurrency/huobi/huobiSwapCoinOrder/del',
            method: 'post',
            data: {
              ids: column.id
            }

<template>
  <div class="app-container">
    <el-form ref="searchForm" :model="searchForm" :inline="true" size="mini">
      <el-form-item label="子账户子账户AM平台账户ID">
        <el-input v-model="searchForm.subAccountId" clearable placeholder="请输入子账户子账户AM平台账户ID"></el-input>
      </el-form-item>
    ...
    <el-table v-loading="subWpSpotOrderHisLoading" :data="subWpSpotOrderHisData" style="width:100%;margin-bottom:20px;" border row-key="id">
...
<!--      <el-table-column prop="remainFrozenCash" label="剩余冻结资金" />-->
    ...
    />
    <el-dialog title="子账户委托订单历史表管理" :visible.sync="subWpSpotOrderHisDialog" :close-on-click-modal="false" width="600">
      <el-form ref="subWpSpotOrderHisForm" :model="subWpSpotOrderHisForm" :rules="subWpSpotOrderHisRules" label-width="150px" class="subWpSpotOrderHisForm">
        <el-row>
          <el-col :span="8">
            <el-form-item label="子账户AM平台账户ID" prop="accountId">
              <el-input v-model="subWpSpotOrderHisForm.accountId" placeholder="请输入子账户AM平台账户ID" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="合约代码" prop="instrumentID">
              <el-input v-model="subWpSpotOrderHisForm.instrumentID" placeholder="请输入合约代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单引用" prop="orderRef">
              <el-input v-model="subWpSpotOrderHisForm.orderRef" placeholder="请输入报单引用" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="用户代码" prop="userID">
              <el-input v-model="subWpSpotOrderHisForm.userID" placeholder="请输入用户代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="报单价格条件" prop="orderPriceType">
              <el-input v-model="subWpSpotOrderHisForm.orderPriceType" placeholder="请输入报单价格条件" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="买卖方向" prop="direction">
              <el-input v-model="subWpSpotOrderHisForm.direction" placeholder="请输入买卖方向(0买、1卖)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="组合开平标志" prop="combOffsetFlag">
              <el-input v-model="subWpSpotOrderHisForm.combOffsetFlag" placeholder="请输入组合开平标志" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="组合投机套保标志" prop="combHedgeFlag">
              <el-input v-model="subWpSpotOrderHisForm.combHedgeFlag" placeholder="请输入组合投机套保标志" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="价格" prop="limitPrice">
              <el-input v-model="subWpSpotOrderHisForm.limitPrice" placeholder="请输入价格" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="数量" prop="volumeTotalOriginal">
              <el-input v-model="subWpSpotOrderHisForm.volumeTotalOriginal" placeholder="请输入数量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="有效期类型" prop="timeCondition">
              <el-input v-model="subWpSpotOrderHisForm.timeCondition" placeholder="请输入有效期类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="GTD日期" prop="gTDDate">
              <el-input v-model="subWpSpotOrderHisForm.gTDDate" placeholder="请输入GTD日期" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="成交量类型" prop="volumeCondition">
              <el-input v-model="subWpSpotOrderHisForm.volumeCondition" placeholder="请输入成交量类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="最小成交量" prop="minVolume">
              <el-input v-model="subWpSpotOrderHisForm.minVolume" placeholder="请输入最小成交量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="触发条件" prop="contingentCondition">
              <el-input v-model="subWpSpotOrderHisForm.contingentCondition" placeholder="请输入触发条件" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="止损价" prop="stopPrice">
              <el-input v-model="subWpSpotOrderHisForm.stopPrice" placeholder="请输入止损价" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="强平原因" prop="forceCloseReason">
              <el-input v-model="subWpSpotOrderHisForm.forceCloseReason" placeholder="请输入强平原因" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="自动挂起标志" prop="isAutoSuspend">
              <el-input v-model="subWpSpotOrderHisForm.isAutoSuspend" placeholder="请输入自动挂起标志" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="业务单元" prop="businessUnit">
              <el-input v-model="subWpSpotOrderHisForm.businessUnit" placeholder="请输入业务单元" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="请求编号" prop="requestID">
              <el-input v-model="subWpSpotOrderHisForm.requestID" placeholder="请输入请求编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="本地报单编号" prop="orderLocalID">
              <el-input v-model="subWpSpotOrderHisForm.orderLocalID" placeholder="请输入本地报单编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所代码" prop="exchangeID">
              <el-input v-model="subWpSpotOrderHisForm.exchangeID" placeholder="请输入交易所代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="会员代码" prop="participantID">
              <el-input v-model="subWpSpotOrderHisForm.participantID" placeholder="请输入会员代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="客户代码" prop="clientID">
              <el-input v-model="subWpSpotOrderHisForm.clientID" placeholder="请输入客户代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="合约在交易所的代码" prop="exchangeInstID">
              <el-input v-model="subWpSpotOrderHisForm.exchangeInstID" placeholder="请输入合约在交易所的代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所交易员代码" prop="traderID">
              <el-input v-model="subWpSpotOrderHisForm.traderID" placeholder="请输入交易所交易员代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="安装编号" prop="installID">
              <el-input v-model="subWpSpotOrderHisForm.installID" placeholder="请输入安装编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="报单提交状态" prop="orderSubmitStatus">
              <el-input v-model="subWpSpotOrderHisForm.orderSubmitStatus" placeholder="请输入报单提交状态" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单提示序号" prop="notifySequence">
              <el-input v-model="subWpSpotOrderHisForm.notifySequence" placeholder="请输入报单提示序号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易日" prop="tradingDay">
              <el-input v-model="subWpSpotOrderHisForm.tradingDay" placeholder="请输入交易日" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="结算编号" prop="settlementID">
              <el-input v-model="subWpSpotOrderHisForm.settlementID" placeholder="请输入结算编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单编号" prop="orderSysID">
              <el-input v-model="subWpSpotOrderHisForm.orderSysID" placeholder="请输入报单编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单来源" prop="orderSource">
              <el-input v-model="subWpSpotOrderHisForm.orderSource" placeholder="请输入报单来源" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="报单状态" prop="orderStatus">
              <el-input v-model="subWpSpotOrderHisForm.orderStatus" placeholder="请输入报单状态" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单类型" prop="orderType">
              <el-input v-model="subWpSpotOrderHisForm.orderType" placeholder="请输入报单类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="今成交数量" prop="volumeTraded">
              <el-input v-model="subWpSpotOrderHisForm.volumeTraded" placeholder="请输入今成交数量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="剩余数量" prop="volumeTotal">
              <el-input v-model="subWpSpotOrderHisForm.volumeTotal" placeholder="请输入剩余数量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="报单日期" prop="insertDate">
              <el-input v-model="subWpSpotOrderHisForm.insertDate" placeholder="请输入报单日期" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="委托时间" prop="insertTime">
              <el-input v-model="subWpSpotOrderHisForm.insertTime" placeholder="请输入委托时间" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="激活时间" prop="activeTime">
              <el-input v-model="subWpSpotOrderHisForm.activeTime" placeholder="请输入激活时间" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="挂起时间" prop="suspendTime">
              <el-input v-model="subWpSpotOrderHisForm.suspendTime" placeholder="请输入挂起时间" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="最后修改时间" prop="updateTime">
              <el-input v-model="subWpSpotOrderHisForm.updateTime" placeholder="请输入最后修改时间" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="撤销时间" prop="cancelTime">
              <el-input v-model="subWpSpotOrderHisForm.cancelTime" placeholder="请输入撤销时间" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="最后修改交易所交易员代码" prop="activeTraderID">
              <el-input v-model="subWpSpotOrderHisForm.activeTraderID" placeholder="请输入最后修改交易所交易员代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="结算会员编号" prop="clearingPartID">
              <el-input v-model="subWpSpotOrderHisForm.clearingPartID" placeholder="请输入结算会员编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="序号" prop="sequenceNo">
              <el-input v-model="subWpSpotOrderHisForm.sequenceNo" placeholder="请输入序号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="前置编号" prop="frontID">
              <el-input v-model="subWpSpotOrderHisForm.frontID" placeholder="请输入前置编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="会话编号" prop="sessionID">
              <el-input v-model="subWpSpotOrderHisForm.sessionID" placeholder="请输入会话编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="用户端产品信息" prop="userProductInfo">
              <el-input v-model="subWpSpotOrderHisForm.userProductInfo" placeholder="请输入用户端产品信息" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="状态信息" prop="statusMsg">
              <el-input v-model="subWpSpotOrderHisForm.statusMsg" placeholder="请输入状态信息" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="用户强评标志" prop="userForceClose">
              <el-input v-model="subWpSpotOrderHisForm.userForceClose" placeholder="请输入用户强评标志" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="操作用户代码" prop="activeUserID">
              <el-input v-model="subWpSpotOrderHisForm.activeUserID" placeholder="请输入操作用户代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="经纪公司报单编号" prop="brokerOrderSeq">
              <el-input v-model="subWpSpotOrderHisForm.brokerOrderSeq" placeholder="请输入经纪公司报单编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="相关报单" prop="relativeOrderSysID">
              <el-input v-model="subWpSpotOrderHisForm.relativeOrderSysID" placeholder="请输入相关报单" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="郑商所成交数量" prop="zCETotalTradedVolume">
              <el-input v-model="subWpSpotOrderHisForm.zCETotalTradedVolume" placeholder="请输入郑商所成交数量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="互换单标志" prop="isSwapOrder">
              <el-input v-model="subWpSpotOrderHisForm.isSwapOrder" placeholder="请输入互换单标志" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="营业部编号" prop="branchID">
              <el-input v-model="subWpSpotOrderHisForm.branchID" placeholder="请输入营业部编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="投资单元代码" prop="investUnitID">
              <el-input v-model="subWpSpotOrderHisForm.investUnitID" placeholder="请输入投资单元代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="币种代码" prop="currencyID">
              <el-input v-model="subWpSpotOrderHisForm.currencyID" placeholder="请输入币种代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="IP地址" prop="iPAddress">
              <el-input v-model="subWpSpotOrderHisForm.iPAddress" placeholder="请输入IP地址" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="Mac地址" prop="macAddress">
              <el-input v-model="subWpSpotOrderHisForm.macAddress" placeholder="请输入Mac地址" />
            </el-form-item>
          </el-col>
        </el-row>
<!--        <el-row>-->
...
<!--              <el-input v-model="subWpSpotOrderHisForm.frozenCommission" placeholder="请输入冻结手续费" />-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--          <el-col :span="8">-->
<!--            <el-form-item label="冻结资金" prop="frozenCash">-->
<!--              <el-input v-model="subWpSpotOrderHisForm.frozenCash" placeholder="请输入冻结资金" />-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--        </el-row>-->
<!--        <el-row>-->
...
<!--              <el-input v-model="subWpSpotOrderHisForm.remainFrozenCommission" placeholder="请输入剩余冻结手续费" />-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--          <el-col :span="8">-->
<!--            <el-form-item label="剩余冻结资金" prop="remainFrozenCash">-->
<!--              <el-input v-model="subWpSpotOrderHisForm.remainFrozenCash" placeholder="请输入剩余冻结资金" />-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--        </el-row>-->
      </el-form>
...
<script>
export default {
  name: 'SubWpSpotOrderHisName',
  data() {
    return {
      subWpSpotOrderHisLoading: true,
      subWpSpotOrderHisDialog: false,
      subWpSpotOrderHisData: [],
      commodityTypeSelects: [],
      dicts: [],
      // orderPriceType: [],
      subWpSpotOrderHisForm: {
        'id': '',
        'subAccountId': '',
        'investorID': '',
        'instrumentID': '',
  ...
  methods: {
    ...
    doSearch: function(data, type) {
      ...
      this.subWpSpotOrderHisLoading = true;
      this.$http({
        url: '/wpspot/subWpSpotOrderHis/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.subWpSpotOrderHisData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.subWpSpotOrderHisLoading = false;
        } else {
    ...
    dialogAdd: function() {
      ...
      this.subWpSpotOrderHisDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.subWpSpotOrderHisForm) {
        this.$refs.subWpSpotOrderHisForm.resetFields();
      }
      this.$http({
        url: '/wpspot/subWpSpotOrderHis/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/wpspot/subWpSpotOrderHis/save',
            method: 'post',
            data: this.subWpSpotOrderHisForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.subWpSpotOrderHisDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/wpspot/subWpSpotOrderHis/del',
          method: 'post',
          data: {
            ids: column.id
          }

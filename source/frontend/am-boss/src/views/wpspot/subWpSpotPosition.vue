<template>
  <div class="app-container">
    ...
    <el-table v-loading="subWpSpotPositionLoading" :data="subWpSpotPositionData" style="width:100%;margin-bottom:20px;" border row-key="id">
...
<!--      <el-table-column prop="id" label="主键" />-->
    ...
    />
    <el-dialog title="子账户持仓汇总表管理" :visible.sync="subWpSpotPositionDialog" :close-on-click-modal="false" width="600">
      <el-form ref="subWpSpotPositionForm" :model="subWpSpotPositionForm" :rules="subWpSpotPositionRules" label-width="150px" class="subWpSpotPositionForm">
        <el-row>
          <el-col :span="8">
            <el-form-item label="AM平台账户ID" prop="accountId">
              <el-input v-model="subWpSpotPositionForm.accountId" placeholder="请输入AM平台账户ID" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="合约代码" prop="instrumentID">
              <el-input v-model="subWpSpotPositionForm.instrumentID" placeholder="请输入合约代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="持仓多空方向" prop="posiDirection">
              <el-select v-model="subWpSpotPositionForm.posiDirection" placeholder="请输入持仓多空方向">
          ...
          <el-col :span="8">
            <el-form-item label="投机套保标志" prop="hedgeFlag">
              <el-select v-model="subWpSpotPositionForm.hedgeFlag" placeholder="请输入投机套保标志">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="持仓日期" prop="positionDate">
              <el-input v-model="subWpSpotPositionForm.positionDate" placeholder="请输入持仓日期">
          ...
          <el-col :span="8">
            <el-form-item label="上日持仓" prop="ydPosition">
              <el-input v-model="subWpSpotPositionForm.ydPosition" placeholder="请输入上日持仓" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="今日持仓" prop="position">
              <el-input v-model="subWpSpotPositionForm.position" placeholder="请输入今日持仓" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="多头冻结" prop="longFrozen">
              <el-input v-model="subWpSpotPositionForm.longFrozen" placeholder="请输入多头冻结" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="空头冻结" prop="shortFrozen">
              <el-input v-model="subWpSpotPositionForm.shortFrozen" placeholder="请输入空头冻结" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开仓冻结金额" prop="longFrozenAmount">
              <el-input v-model="subWpSpotPositionForm.longFrozenAmount" placeholder="请输入开仓冻结金额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="开仓冻结金额" prop="shortFrozenAmount">
              <el-input v-model="subWpSpotPositionForm.shortFrozenAmount" placeholder="请输入开仓冻结金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开仓量" prop="openVolume">
              <el-input v-model="subWpSpotPositionForm.openVolume" placeholder="请输入开仓量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="平仓量" prop="closeVolume">
              <el-input v-model="subWpSpotPositionForm.closeVolume" placeholder="请输入平仓量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="开仓金额" prop="openAmount">
              <el-input v-model="subWpSpotPositionForm.openAmount" placeholder="请输入开仓金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="平仓金额" prop="closeAmount">
              <el-input v-model="subWpSpotPositionForm.closeAmount" placeholder="请输入平仓金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="持仓成本" prop="positionCost">
              <el-input v-model="subWpSpotPositionForm.positionCost" placeholder="请输入持仓成本" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上次占用的保证金" prop="preMargin">
              <el-input v-model="subWpSpotPositionForm.preMargin" placeholder="请输入上次占用的保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="占用的保证金" prop="useMargin">
              <el-input v-model="subWpSpotPositionForm.useMargin" placeholder="请输入占用的保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结的保证金" prop="frozenMargin">
              <el-input v-model="subWpSpotPositionForm.frozenMargin" placeholder="请输入冻结的保证金" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="冻结的资金" prop="frozenCash">
              <el-input v-model="subWpSpotPositionForm.frozenCash" placeholder="请输入冻结的资金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结的手续费" prop="frozenCommission">
              <el-input v-model="subWpSpotPositionForm.frozenCommission" placeholder="请输入冻结的手续费" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="资金差额" prop="cashIn">
              <el-input v-model="subWpSpotPositionForm.cashIn" placeholder="请输入资金差额" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="手续费" prop="commission">
              <el-input v-model="subWpSpotPositionForm.commission" placeholder="请输入手续费" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="手续费" prop="commission">
          ...
          <el-col :span="8">
            <el-form-item label="平仓盈亏" prop="closeProfit">
              <el-input v-model="subWpSpotPositionForm.closeProfit" placeholder="请输入平仓盈亏" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="持仓盈亏" prop="positionProfit">
              <el-input v-model="subWpSpotPositionForm.positionProfit" placeholder="请输入持仓盈亏" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上次结算价" prop="preSettlementPrice">
              <el-input v-model="subWpSpotPositionForm.preSettlementPrice" placeholder="请输入上次结算价" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="本次结算价" prop="settlementPrice">
              <el-input v-model="subWpSpotPositionForm.settlementPrice" placeholder="请输入本次结算价" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易日" prop="tradingDay">
              <el-input v-model="subWpSpotPositionForm.tradingDay" placeholder="请输入交易日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="结算编号" prop="settlementID">
              <el-input v-model="subWpSpotPositionForm.settlementID" placeholder="请输入结算编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开仓成本" prop="openCost">
              <el-input v-model="subWpSpotPositionForm.openCost" placeholder="请输入开仓成本" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所保证金" prop="exchangeMargin">
              <el-input v-model="subWpSpotPositionForm.exchangeMargin" placeholder="请输入交易所保证金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="组合成交形成的持仓" prop="combPosition">
              <el-input v-model="subWpSpotPositionForm.combPosition" placeholder="请输入组合成交形成的持仓" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="组合多头冻结" prop="combLongFrozen">
              <el-input v-model="subWpSpotPositionForm.combLongFrozen" placeholder="请输入组合多头冻结" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="组合空头冻结" prop="combShortFrozen">
              <el-input v-model="subWpSpotPositionForm.combShortFrozen" placeholder="请输入组合空头冻结" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="逐日盯市平仓盈亏" prop="closeProfitByDate">
              <el-input v-model="subWpSpotPositionForm.closeProfitByDate" placeholder="请输入逐日盯市平仓盈亏" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="逐笔对冲平仓盈亏" prop="closeProfitByTrade">
              <el-input v-model="subWpSpotPositionForm.closeProfitByTrade" placeholder="请输入逐笔对冲平仓盈亏" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="今日持仓" prop="todayPosition">
              <el-input v-model="subWpSpotPositionForm.todayPosition" placeholder="请输入今日持仓" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="保证金率" prop="marginRateByMoney">
              <el-input v-model="subWpSpotPositionForm.marginRateByMoney" placeholder="请输入保证金率" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="保证金率(按手数)" prop="marginRateByVolume">
              <el-input v-model="subWpSpotPositionForm.marginRateByVolume" placeholder="请输入保证金率(按手数)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="执行冻结" prop="strikeFrozen">
              <el-input v-model="subWpSpotPositionForm.strikeFrozen" placeholder="请输入执行冻结" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="执行冻结金额" prop="strikeFrozenAmount">
              <el-input v-model="subWpSpotPositionForm.strikeFrozenAmount" placeholder="请输入执行冻结金额" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="放弃执行冻结" prop="abandonFrozen">
              <el-input v-model="subWpSpotPositionForm.abandonFrozen" placeholder="请输入放弃执行冻结" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所代码" prop="exchangeID">
              <el-input v-model="subWpSpotPositionForm.exchangeID" placeholder="请输入交易所代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="执行冻结的昨仓" prop="ydStrikeFrozen">
              <el-input v-model="subWpSpotPositionForm.ydStrikeFrozen" placeholder="请输入执行冻结的昨仓" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="投资单元代码" prop="investUnitID">
              <el-input v-model="subWpSpotPositionForm.investUnitID" placeholder="请输入投资单元代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="大商所持仓成本差值，只有大商所使用" prop="positionCostOffset">
              <el-input v-model="subWpSpotPositionForm.positionCostOffset" placeholder="请输入大商所持仓成本差值，只有大商所使用" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="tas持仓手数" prop="tasPosition">
              <el-input v-model="subWpSpotPositionForm.tasPosition" placeholder="请输入tas持仓手数" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="tas持仓手数" prop="tasPosition">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="tas持仓成本" prop="tasPositionCost">
              <el-input v-model="subWpSpotPositionForm.tasPositionCost" placeholder="请输入tas持仓成本" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
export default {
  name: 'SubWpSpotPositionName',
  data() {
    return {
      subWpSpotPositionLoading: true,
      subWpSpotPositionDialog: false,
      subWpSpotPositionData: [],
      commodityTypeSelects: [],
      dicts: [],
      posiDirection: [],
      hedgeFlag: [],
      positionDate: [],
      subWpSpotPositionForm: {
        'id': '',
        'subAccountId': '',
        'instrumentID': '',
        'posiDirection': '',
  ...
  methods: {
    ...
    doSearch: function(data, type) {
      ...
      this.subWpSpotPositionLoading = true;
      this.$http({
        url: '/wpspot/subWpSpotPosition/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.subWpSpotPositionData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.subWpSpotPositionLoading = false;
        } else {
    ...
    dialogAdd: function() {
      ...
      this.subWpSpotPositionDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.subWpSpotPositionForm) {
        this.$refs.subWpSpotPositionForm.resetFields();
      }
      this.$http({
        url: '/wpspot/subWpSpotPosition/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/wpspot/subWpSpotPosition/save',
            method: 'post',
            data: this.subWpSpotPositionForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.subWpSpotPositionDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/wpspot/subWpSpotPosition/del',
          method: 'post',
          data: {
            ids: column.id
          }

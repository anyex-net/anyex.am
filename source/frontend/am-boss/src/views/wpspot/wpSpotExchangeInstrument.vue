...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="wpSpotExchangeInstrumentLoading" :data="wpSpotExchangeInstrumentData" style="width:100%;margin-bottom:20px;" border row-key="id">
      ...
      <el-table-column prop="productClass" label="产品类型" :formatter="specialStatusFormat" />
    ...
    />
    <el-dialog title="外盘现货交易所合约表管理" :visible.sync="wpSpotExchangeInstrumentDialog" :close-on-click-modal="false" width="600">
      <el-form ref="wpSpotExchangeInstrumentForm" :model="wpSpotExchangeInstrumentForm" :rules="wpSpotExchangeInstrumentRules" label-width="150px" class="wpSpotExchangeInstrumentForm">
        <el-row>
          <el-col :span="8">
            <el-form-item label="合约代码" prop="instrumentID">
              <el-input v-model="wpSpotExchangeInstrumentForm.instrumentID" placeholder="请输入合约代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所代码" prop="exchangeID">
              <el-input v-model="wpSpotExchangeInstrumentForm.exchangeID" placeholder="请输入交易所代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="合约名称" prop="instrumentName">
              <el-input v-model="wpSpotExchangeInstrumentForm.instrumentName" placeholder="请输入合约名称" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="合约在交易所的代码" prop="exchangeInstID">
              <el-input v-model="wpSpotExchangeInstrumentForm.exchangeInstID" placeholder="请输入合约在交易所的代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="产品代码" prop="productID">
              <el-input v-model="wpSpotExchangeInstrumentForm.productID" placeholder="请输入产品代码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="产品类型" prop="productClass">
              <el-select v-model="wpSpotExchangeInstrumentForm.productClass" placeholder="请选择产品类型">
                <el-option v-for="data in productClass" :key="data.key" :label="data.value" :value="data.key" />
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="交割年份" prop="deliveryYear">
              <el-input v-model="wpSpotExchangeInstrumentForm.deliveryYear" placeholder="请输入交割年份" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交割月" prop="deliveryMonth">
              <el-input v-model="wpSpotExchangeInstrumentForm.deliveryMonth" placeholder="请输入交割月" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="市价单最大下单量" prop="maxMarketOrderVolume">
              <el-input v-model="wpSpotExchangeInstrumentForm.maxMarketOrderVolume" placeholder="请输入市价单最大下单量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="市价单最小下单量" prop="minMarketOrderVolume">
              <el-input v-model="wpSpotExchangeInstrumentForm.minMarketOrderVolume" placeholder="请输入市价单最小下单量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="限价单最大下单量" prop="maxLimitOrderVolume">
              <el-input v-model="wpSpotExchangeInstrumentForm.maxLimitOrderVolume" placeholder="请输入限价单最大下单量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="限价单最小下单量" prop="minLimitOrderVolume">
              <el-input v-model="wpSpotExchangeInstrumentForm.minLimitOrderVolume" placeholder="请输入限价单最小下单量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="合约数量乘数" prop="volumeMultiple">
              <el-input v-model="wpSpotExchangeInstrumentForm.volumeMultiple" placeholder="请输入合约数量乘数" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="最小变动价位" prop="priceTick">
              <el-input v-model="wpSpotExchangeInstrumentForm.priceTick" placeholder="请输入最小变动价位" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="创建日" prop="createDate">
              <el-input v-model="wpSpotExchangeInstrumentForm.createDate" placeholder="请输入创建日" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上市日" prop="openDate">
              <el-input v-model="wpSpotExchangeInstrumentForm.openDate" placeholder="请输入上市日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="到期日" prop="expireDate">
              <el-input v-model="wpSpotExchangeInstrumentForm.expireDate" placeholder="请输入到期日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开始交割日" prop="startDelivDate">
              <el-input v-model="wpSpotExchangeInstrumentForm.startDelivDate" placeholder="请输入开始交割日" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="结束交割日" prop="endDelivDate">
              <el-input v-model="wpSpotExchangeInstrumentForm.endDelivDate" placeholder="请输入结束交割日" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="合约生命周期状态" prop="instLifePhase">
              <el-select v-model="wpSpotExchangeInstrumentForm.instLifePhase" placeholder="请选择合约生命周期状态">
          ...
          <el-col :span="8">
            <el-form-item label="当前是否交易" prop="isTrading">
              <el-input v-model="wpSpotExchangeInstrumentForm.isTrading" placeholder="请输入当前是否交易" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="持仓类型" prop="positionType">
              <el-select v-model="wpSpotExchangeInstrumentForm.positionType" placeholder="请选择持仓类型">
          ...
          <el-col :span="8">
            <el-form-item label="持仓日期类型" prop="positionDateType">
              <el-select v-model="wpSpotExchangeInstrumentForm.positionDateType" placeholder="请选择持仓日期类型">
          ...
          <el-col :span="8">
            <el-form-item label="多头保证金率" prop="longMarginRatio">
              <el-input v-model="wpSpotExchangeInstrumentForm.longMarginRatio" placeholder="请输入多头保证金率" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="空头保证金率" prop="shortMarginRatio">
              <el-input v-model="wpSpotExchangeInstrumentForm.shortMarginRatio" placeholder="请输入空头保证金率" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否使用大额单边保证金算法" prop="maxMarginSideAlgorithm">
              <el-select v-model="wpSpotExchangeInstrumentForm.maxMarginSideAlgorithm" placeholder="请选择是否使用大额单边保证金算法">
          ...
          <el-col :span="8">
            <el-form-item label="基础商品代码" prop="underlyingInstrID">
              <el-input v-model="wpSpotExchangeInstrumentForm.underlyingInstrID" placeholder="请输入基础商品代码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="执行价" prop="strikePrice">
              <el-input v-model="wpSpotExchangeInstrumentForm.strikePrice" placeholder="请输入执行价" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="期权类型" prop="optionsType">
              <el-select v-model="wpSpotExchangeInstrumentForm.optionsType" placeholder="请输入期权类型">
          ...
          <el-col :span="8">
            <el-form-item label="合约基础商品乘数" prop="underlyingMultiple">
              <el-input v-model="wpSpotExchangeInstrumentForm.underlyingMultiple" placeholder="请输入合约基础商品乘数" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="组合类型" prop="combinationType">
              <el-select v-model="wpSpotExchangeInstrumentForm.combinationType" placeholder="请输入组合类型">
          ...
          <el-col :span="8">
            <el-form-item label="启用状态" prop="enableStatus">
              <el-select v-model="wpSpotExchangeInstrumentForm.enableStatus" placeholder="请选择启用状态">
                <el-option key="enable" label="是" value="enable" />
                <el-option key="disable" label="否" value="disable" />
              </el-select>
            </el-form-item>
        ...
        <el-row>
          <el-col :span="24" align="center">
            <el-form-item>
              <el-button type="success" @click="doSubmit('wpSpotExchangeInstrumentForm')">提交</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
export default {
  name: 'WpSpotExchangeInstrumentName',
  data() {
    return {
      wpSpotExchangeInstrumentLoading: true,
      wpSpotExchangeInstrumentDialog: false,
      wpSpotExchangeInstrumentData: [],
      ...
      wpSpotExchangeInstrumentRules: {
        ...
        productClass: [
          { required: true, message: '产品类型(产品类型数据字典)不可为空', trigger: 'change' }
        ],
        deliveryYear: [
        ...
        instLifePhase: [
          { required: true, message: '合约生命周期状态(合约生命周期状态类型数据字典)不可为空', trigger: 'change' }
        ],
        isTrading: [
          { required: true, message: '当前是否交易不可为空', trigger: 'change' }
        ],
        positionType: [
          { required: true, message: '持仓类型(持仓类型数据字典)不可为空', trigger: 'change' }
        ],
        positionDateType: [
          { required: true, message: '持仓日期类型(持仓日期类型数据字典)不可为空', trigger: 'change' }
        ],
        longMarginRatio: [
        ...
        maxMarginSideAlgorithm: [
          { required: true, message: '是否使用大额单边保证金算法(大额单边保证金算法类型数据字典)不可为空', trigger: 'change' }
        ],
        strikePrice: [
        ...
        combinationType: [
          { required: true, message: '组合类型(组合类型数据字典)不可为空', trigger: 'change' }
        ],
        enableStatus: [
  ...
  methods: {
    ...
    specialStatusFormat: function(row, column) {
      const date = row[column.property];
      if (date === undefined || date === '') {
        return '';
      }
    ...
    doInitData() {
      this.$http({
        url: '/wpspot/dict/wpSpotExchangeInstrument',
        method: 'get'
      }).then(res => {
        if (res.code === 200) {
    ...
    doSearch: function(data, type) {
      ...
      this.wpSpotExchangeInstrumentLoading = true;
      this.$http({
        url: '/wpspot/wpSpotExchangeInstrument/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.wpSpotExchangeInstrumentData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.wpSpotExchangeInstrumentLoading = false;
        } else {
    ...
    dialogAdd: function() {
      this.wpSpotExchangeInstrumentForm = {
        'id': '',
        'instrumentID': '',
        'exchangeID': '',
        'instrumentName': '',
      ...
      this.wpSpotExchangeInstrumentDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.wpSpotExchangeInstrumentForm) {
        this.$refs.wpSpotExchangeInstrumentForm.resetFields();
      }
      this.$http({
        url: '/wpspot/wpSpotExchangeInstrument/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/wpspot/wpSpotExchangeInstrument/save',
            method: 'post',
            data: this.wpSpotExchangeInstrumentForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.wpSpotExchangeInstrumentDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/wpspot/wpSpotExchangeInstrument/del',
          method: 'post',
          data: {
            ids: column.id
          }

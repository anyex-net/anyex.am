<template>
  <div class="app-container">
    ...
    <el-table
      v-loading="subWpfuturesOrderInfoHisLoading"
      :data="subWpfuturesOrderInfoHisData"
    ...
    <el-dialog
      title="子账户委托订单历史表管理"
      :visible.sync="subWpfuturesOrderInfoHisDialog"
      :close-on-click-modal="false"
      width="600"
    >
      <el-form
        ref="subWpfuturesOrderInfoHisForm"
        :model="subWpfuturesOrderInfoHisForm"
        label-width="150px"
        class="subWpfuturesOrderInfoHisForm"
      >
        <el-row>
          <el-col :span="8">
            <el-form-item label="主键" prop="accountId">
              <el-input v-model="subWpfuturesOrderInfoHisForm.id" placeholder="请输入主键" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="AM平台账户ID" prop="accountId">
              <el-input v-model="subWpfuturesOrderInfoHisForm.subAccountId" placeholder="请输入子账户AM平台账户ID" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易所编号" prop="exchangeNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.exchangeNo" placeholder="请输入交易所编号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="品种类型" prop="commodityType">
              <el-select v-model="subWpfuturesOrderInfoHisForm.commodityType" clearable placeholder="请输入品种类型" value="">
                <el-option v-for="data in dicts.commodityType" :key="data.key" :label="data.value" :value="data.key">
                </el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :span="8">
            <el-form-item label="品种编码类型" prop="commodityNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.commodityNo" placeholder="请输入品种编码类型" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="合约1" prop="contractNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.contractNo" placeholder="请输入合约1" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="执行价格1" prop="strikePrice">
              <el-input v-model="subWpfuturesOrderInfoHisForm.strikePrice" placeholder="请输入执行价格1" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="看张看跌1" prop="callOrPutFlag">
              <el-select v-model="subWpfuturesOrderInfoHisForm.callOrPutFlag" clearable placeholder="请输入看张看跌1" value="">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="合约2" prop="contractNo2">
              <el-input v-model="subWpfuturesOrderInfoHisForm.contractNo2" placeholder="请输入合约2" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="执行价格2" prop="strikePrice2">
              <el-input v-model="subWpfuturesOrderInfoHisForm.strikePrice2" placeholder="请输入执行价格2" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="看张看跌2" prop="callOrPutFlag2">
              <el-select v-model="subWpfuturesOrderInfoHisForm.callOrPutFlag2" clearable placeholder="请输入看张看跌2" value="">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="委托类型" prop="orderType">
              <el-select v-model="subWpfuturesOrderInfoHisForm.orderType" clearable placeholder="请输入委托类型" value="">
          ...
          <el-col :span="8">
            <el-form-item label="委托来源" prop="orderSource">
              <el-select v-model="subWpfuturesOrderInfoHisForm.orderSource" clearable placeholder="请输入委托来源" value="">
          ...
          <el-col :span="8">
            <el-form-item label="委托有效类型" prop="timeInForce">
              <el-select v-model="subWpfuturesOrderInfoHisForm.timeInForce" clearable placeholder="请输入委托有效类型" value="">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="有效日期" prop="expireTime">
              <el-input v-model="subWpfuturesOrderInfoHisForm.expireTime" placeholder="请输入有效日期(GTD情况下使用)" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否风险报单" prop="isRiskOrder">
              <el-select v-model="subWpfuturesOrderInfoHisForm.isRiskOrder" clearable placeholder="请输入是否风险报单" value="">
          ...
          <el-col :span="8">
            <el-form-item label="买入卖出" prop="orderSide">
              <el-select v-model="subWpfuturesOrderInfoHisForm.orderSide" clearable placeholder="请输入买入卖出" value="">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="开平标志1" prop="positionEffect">
              <el-select v-model="subWpfuturesOrderInfoHisForm.positionEffect1" clearable placeholder="请输入开平标志1" value="">
          ...
          <el-col :span="8">
            <el-form-item label="开平标志2" prop="positionEffect2">
              <el-select v-model="subWpfuturesOrderInfoHisForm.positionEffect2" clearable placeholder="请输入开平标志2" value="">
          ...
          <el-col :span="8">
            <el-form-item label="询价号" prop="inquiryNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.inquiryNo" placeholder="请输入询价号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="投机保值" prop="hedgeFlag">
              <el-select v-model="subWpfuturesOrderInfoHisForm.hedgeFlag" clearable placeholder="请输入投机保值" value="">
          ...
          <el-col :span="8">
            <el-form-item label="委托价格1" prop="orderPrice">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderPrice" placeholder="请输入委托价格1" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托价格2" prop="orderPrice2">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderPrice2" placeholder="请输入委托价格2，做市商应价使用" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="触发价格" prop="stopPrice">
              <el-input v-model="subWpfuturesOrderInfoHisForm.stopPrice" placeholder="请输入触发价格" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托数量" prop="orderQty">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderQty" placeholder="请输入委托数量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="最小成交量" prop="orderMinQty">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderMinQty" placeholder="请输入最小成交量" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="整型参考值" prop="refInt">
              <el-input v-model="subWpfuturesOrderInfoHisForm.refInt" placeholder="请输入整型参考值" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="浮点参考值" prop="refDouble">
              <el-input v-model="subWpfuturesOrderInfoHisForm.refDouble" placeholder="请输入浮点参考值" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="字符串参考值" prop="refString">
              <el-input v-model="subWpfuturesOrderInfoHisForm.refString" placeholder="请输入字符串参考值" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="冰山单最小随机量" prop="minClipSize">
              <el-input v-model="subWpfuturesOrderInfoHisForm.minClipSize" placeholder="请输入冰山单最小随机量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冰山单最大随机量" prop="maxClipSize">
              <el-input v-model="subWpfuturesOrderInfoHisForm.maxClipSize" placeholder="请输入冰山单最大随机量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="软件授权号" prop="licenseNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.licenseNo" placeholder="请输入软件授权号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="服务器标识" prop="serverFlag">
              <el-input v-model="subWpfuturesOrderInfoHisForm.serverFlag" placeholder="请输入服务器标识" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托编码" prop="orderNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderNo" placeholder="请输入委托编码" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="本地委托编号" prop="clientOrderNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.clientOrderNo" placeholder="请输入客户端本地委托编号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="客户子账号(对象)" prop="clientID">
              <el-input v-model="subWpfuturesOrderInfoHisForm.clientID" placeholder="请输入客户子账号(对象)" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="策略单类型" prop="tacticsType">
              <el-input v-model="subWpfuturesOrderInfoHisForm.tacticsType" placeholder="请输入策略单类型" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="触发条件" prop="triggerCondition">
              <el-select v-model="subWpfuturesOrderInfoHisForm.triggerCondition" clearable placeholder="请输入触发条件" value="">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="触发价格类型" prop="triggerPriceType">
              <el-select v-model="subWpfuturesOrderInfoHisForm.triggerPriceType" clearable placeholder="请输入触发价格类型" value="">
          ...
          <el-col :span="8">
            <el-form-item label="是否T+1有效" prop="addOneIsValid">
              <el-select v-model="subWpfuturesOrderInfoHisForm.addOneIsValid" clearable placeholder="请输入是否T+1有效" value="">
          ...
          <el-col :span="8">
            <el-form-item label="终端本地IP" prop="clientLocalIP">
              <el-input v-model="subWpfuturesOrderInfoHisForm.clientLocalIP" placeholder="请输入终端本地IP" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="终端本地Mac地址" prop="clientMac">
              <el-input v-model="subWpfuturesOrderInfoHisForm.clientMac" placeholder="请输入终端本地Mac地址" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="终端网络地址" prop="clientIP">
              <el-input v-model="subWpfuturesOrderInfoHisForm.clientIP" placeholder="请输入终端网络地址" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托流水号" prop="orderStreamID">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderStreamID" placeholder="请输入委托流水号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上手号" prop="upperNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.upperNo" placeholder="请输入上手号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="上手通道号" prop="upperChannelNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.upperChannelNo" placeholder="请输入上手通道号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="本地号" prop="orderLocalNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderLocalNo" placeholder="请输入本地号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="上手流号" prop="upperStreamID">
              <el-input v-model="subWpfuturesOrderInfoHisForm.upperStreamID" placeholder="请输入上手流号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="系统号" prop="orderSystemNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderSystemNo" placeholder="请输入系统号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="交易所系统号" prop="orderExchangeSystemNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderExchangeSystemNo" placeholder="请输入交易所系统号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="父单系统号" prop="orderParentSystemNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderParentSystemNo" placeholder="请输入父单系统号" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="下单人" prop="orderInsertUserNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderInsertUserNo" placeholder="请输入下单人" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="下单时间" prop="orderInsertTime">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderInsertTime" placeholder="请输入下单时间" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="录单操作人" prop="orderCommandUserNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderCommandUserNo" placeholder="请输入录单操作人" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托更新人" prop="orderUpdateUserNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderUpdateUserNo" placeholder="请输入委托更新人" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="委托更新时间" prop="orderUpdateTime">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderUpdateTime" placeholder="请输入委托更新时间" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="委托状态" prop="orderState">
              <el-select v-model="subWpfuturesOrderInfoHisForm.orderState" clearable placeholder="请输入委托状态" value="">
          ...
          <el-col :span="8">
            <el-form-item label="成交价1" prop="orderMatchPrice">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderMatchPrice" placeholder="请输入成交价1" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="成交价2" prop="orderMatchPrice2">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderMatchPrice2" placeholder="请输入成交价2" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="成交量1" prop="orderMatchQty">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderMatchQty" placeholder="请输入成交量1" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="成交量2" prop="orderMatchQty2">
              <el-input v-model="subWpfuturesOrderInfoHisForm.orderMatchQty2" placeholder="请输入成交量2" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="信息码" prop="errorCode">
              <el-input v-model="subWpfuturesOrderInfoHisForm.errorCode" placeholder="请输入最后一次操作错误信息码" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="错误信息" prop="errorText">
              <el-input v-model="subWpfuturesOrderInfoHisForm.errorText" placeholder="请输入错误信息" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否为录入委托单" prop="isBackInput">
              <el-select v-model="subWpfuturesOrderInfoHisForm.isBackInput" clearable placeholder="请输入是否为录入委托单" value="">
          ...
          <el-col :span="8">
            <el-form-item label="委托成交删除标" prop="isDeleted">
              <el-select v-model="subWpfuturesOrderInfoHisForm.isDeleted" clearable placeholder="请输入委托成交删除标" value="">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="是否为T+1单" prop="isAddOne">
              <el-select v-model="subWpfuturesOrderInfoHisForm.isAddOne" clearable placeholder="请输入是否为T+1单" value="">
          ...
          <el-col :span="8">
            <el-form-item label="币种" prop="currencyNo">
              <el-input v-model="subWpfuturesOrderInfoHisForm.currencyNo" placeholder="请输入币种" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结保证金" prop="frozenDeposit">
              <el-input v-model="subWpfuturesOrderInfoHisForm.frozenDeposit" placeholder="请输入冻结保证金" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="冻结资金" prop="frozenFund">
              <el-input v-model="subWpfuturesOrderInfoHisForm.frozenFund" placeholder="请输入冻结资金" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="冻结手续费" prop="frozenFee">
              <el-input v-model="subWpfuturesOrderInfoHisForm.frozenFee" placeholder="请输入冻结手续费" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
export default {
  name: 'SubWpfuturesOrderInfoHisName',
  data() {
    return {
      subWpfuturesOrderInfoHisLoading: true,
      subWpfuturesOrderInfoHisDialog: false,
      subWpfuturesOrderInfoHisData: [],
      commodityTypeSelects: [],
      dicts: [],
      subWpfuturesOrderInfoHisForm: {
        'id': '',
        'subAccountId': '',
        'exchangeNo': '',
        'commodityType': '',
  ...
  methods: {
    ...
    doSearch: function(data, type) {
      ...
      this.subWpfuturesOrderInfoHisLoading = true;
      this.$http({
        url: '/wpfutures/subWpfuturesOrderInfoHis/data',
        method: 'post',
        data: Object.assign(this.pageParams, this.searchForm)
      }).then(res => {
        if (res.code === 200) {
          this.subWpfuturesOrderInfoHisData = res.rows;
          this.pageParams.totalPage = res.totalPage;
          this.pageParams.total = res.total;
          this.subWpfuturesOrderInfoHisLoading = false;
        } else {
    ...
    dialogAdd: function() {
      this.subWpfuturesOrderInfoHisForm = {
        'id': '',
        'subAccountId': '',
        'exchangeNo': '',
        'commodityType': '',
      ...
      this.subWpfuturesOrderInfoHisDialog = true;
    },
    dialogEdit: function(row, column) {
      if (this.$refs.subWpfuturesOrderInfoHisForm) {
        this.$refs.subWpfuturesOrderInfoHisForm.resetFields();
      }
      this.$http({
        url: '/wpfutures/subWpfuturesOrderInfoHis/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/wpfutures/subWpfuturesOrderInfoHis/save',
            method: 'post',
            data: this.subWpfuturesOrderInfoHisForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.subWpfuturesOrderInfoHisDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除该记录吗, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/wpfutures/subWpfuturesOrderInfoHis/del',
          method: 'post',
          data: {
            ids: column.id
          }

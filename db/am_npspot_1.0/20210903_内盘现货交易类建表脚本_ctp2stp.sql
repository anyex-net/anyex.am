...
drop table if exists NpSpotAccountInfo;
create table NpSpotAccountInfo
(
...
drop table if exists NpSpotTradingAccount;
create table NpSpotTradingAccount
(
    id                                      bigint                   not null comment '主键' primary key,
    accountId                               bigint(20)               not null comment 'AM平台账户ID',
    BrokerID                                varchar(12)              not null comment '经纪公司代码',
...
/*
drop table if exists NpSpotInvestorPositionDetail;
create table NpSpotInvestorPositionDetail
(
    id                       bigint                    not null comment '主键' primary key,
    accountId                bigint(20)                not null comment 'AM平台账户ID',
...
drop table if exists NpSpotInvestorPosition;
create table NpSpotInvestorPosition
(
    id                       bigint                   not null comment '主键' primary key,
    accountId                bigint(20)               not null comment 'AM平台账户ID',
    InstrumentID             varchar(32)              not null comment '合约代码',
...
drop table if exists NpSpotOrder;
create table NpSpotOrder
(
    id                    bigint                   not null comment '主键' primary key,
    accountId             bigint(20)               not null comment 'AM平台账户ID',
    BrokerID              varchar(12)              not null comment '经纪公司代码',
    ...
    UserID                varchar(17)                       comment '用户代码',
    ...
    TimeCondition         char(1)                           comment '有效期类型',
    ...
    ContingentCondition   char(1)                           comment '触发条件(触发条件类型数据字典)',
    StopPrice             decimal(22, 8) default 0 not null comment '止损价',
    ForceCloseReason      char(1)                           comment '强平原因(强平原因类型数据字典)',
...
drop table if exists NpSpotTrade;
create table NpSpotTrade
(
    id                  bigint                   not null comment '主键' primary key,
    accountId           bigint(20)               not null comment 'AM平台账户ID',
    BrokerID            varchar(12)              not null comment '经纪公司代码',
...
drop table if exists NpSpotOrderHis;
create table NpSpotOrderHis
(
    id                    bigint                   not null comment '主键' primary key,
    accountId             bigint(20)               not null comment 'AM平台账户ID',
    BrokerID              varchar(12)              not null comment '经纪公司代码',
    ...
    GTDDate               varchar(10)                       comment 'GTD日期',
    VolumeCondition       char(1)                           comment '成交量类型(成交量类型类型数据字典)',
    MinVolume             int(11)                  not null comment '最小成交量',

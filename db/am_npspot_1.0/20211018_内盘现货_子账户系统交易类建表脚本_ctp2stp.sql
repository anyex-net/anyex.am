...
drop table if exists SubNpspotAccountInfo;
create table SubNpspotAccountInfo
(
...
drop table if exists SubNpspotTradingAccount;
create table SubNpspotTradingAccount
(
    id                                      bigint                   not null comment '主键' primary key,
    SubAccountId                            bigint(20)               not null comment '子账户AM平台账户ID',
    /*
...
drop table if exists SubNpspotPosition;
create table SubNpspotPosition
(
    id                       bigint                   not null comment '主键' primary key,
    SubAccountId             bigint(20)               not null comment '子账户AM平台账户ID',
...
drop table if exists SubNpspotPositionDetail;
create table SubNpspotPositionDetail
(
    id                       bigint                    not null comment '主键' primary key,
    SubAccountId             bigint(20)                not null comment '子账户AM平台账户ID',
    InstrumentID             varchar(32)               not null comment '合约代码',
...
drop table if exists SubNpspotOrder;
create table SubNpspotOrder
(
    id                    bigint                   not null comment '主键' primary key,
    SubAccountId          bigint(20)               not null comment '子账户AM平台账户ID',
    /*
...
drop table if exists SubNpspotTrade;
create table SubNpspotTrade
(
    id                  bigint                   not null comment '主键' primary key,
    SubAccountId        bigint(20)               not null comment '子账户AM平台账户ID',
    /*
...
drop table if exists SubNpspotOrderHis;
create table SubNpspotOrderHis
(
    id                    bigint                   not null comment '主键' primary key,
    SubAccountId          bigint(20)               not null comment '子账户AM平台账户ID',
    /*

...
drop table if exists NpfuturesBroker;
create table NpfuturesBroker
(
...
drop table if exists NpfuturesExchange;
create table NpfuturesExchange
(
    id                bigint                            not null comment '主键' primary key,
...
drop table if exists NpfuturesExchangeInstrument;
create table NpfuturesExchangeInstrument
(
    id                      bigint                           not null comment '主键' primary key,
    ...
    expireDate              varchar(10)                      not null comment '到期日',
    startDelivDate          varchar(10)                               comment '开始交割日',
    endDelivDate            varchar(10)                      not null comment '结束交割日',
...
) comment '内盘期货交易所期货合约表';

drop table if exists NpfuturesDepthMarketData;
create table NpfuturesDepthMarketData
(
    id                   bigint                         not null comment '主键' primary key,
...
drop table if exists NpfuturesExchangeTradeDay;
create table NpfuturesExchangeTradeDay
(
    id                      bigint                        not null comment '主键' primary key,
    exchangeID              varchar(10)                   not null comment '交易所代码',
    productID               varchar(32)                   not null comment '产品代码',

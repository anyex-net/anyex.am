...
drop table if exists SubNpfuturesAccountInfo;
create table SubNpfuturesAccountInfo
(
    id                              bigint        not null comment '主键' primary key,
    SubAccountId                    bigint(20)    not null comment '子账户AM平台账户ID',
    MotherNpfuturesAccountInfoId    bigint(20)    not null comment '母账户内盘期货投资者帐号ID',
    remark                          varchar(256)  not null comment '备注',
    unique index (`SubAccountId`)
) comment '子账户投资帐号信息表';

drop table if exists SubNpfuturesTradingAccount;
create table SubNpfuturesTradingAccount
(
    id                                      bigint                   not null comment '主键' primary key,
    SubAccountId                            bigint(20)               not null comment '子账户AM平台账户ID',
    /*
    ...
    */
    ...
    /*unique index (`SubAccountId`, `BrokerID`, `InvestorID`, `TradingDay`)*/
    unique index (`SubAccountId`, `TradingDay`)
) comment '子账户资金账户息表';

drop table if exists SubNpfuturesPosition;
create table SubNpfuturesPosition
(
    id                       bigint                   not null comment '主键' primary key,
    SubAccountId             bigint(20)               not null comment '子账户AM平台账户ID',
    ...
    */
    ...
    /*unique index (`SubAccountId`, `InstrumentID`, `BrokerID`, `InvestorID`, `PosiDirection`, `HedgeFlag`, `PositionDate`)*/
    unique index (`SubAccountId`, `InstrumentID`, `PosiDirection`, `HedgeFlag`, `PositionDate`)
) comment '子账户持仓汇总表';

drop table if exists SubNpfuturesPositionDetail;
create table SubNpfuturesPositionDetail
(
    id                       bigint                    not null comment '主键' primary key,
    SubAccountId             bigint(20)                not null comment '子账户AM平台账户ID',
    InstrumentID             varchar(32)               not null comment '合约代码',
    ...
    */
    ...
    InvestUnitID             varchar(18)               not null comment '投资单元代码',
    SpecPosiType             char(1)                   not null comment '特殊持仓标志(特殊持仓明细标识类型数据字典)',
    /*unique index (`SubAccountId`, `InstrumentID`, `BrokerID`, `InvestorID`, `HedgeFlag`, `Direction`, `TradeType`, `OpenDate`, `TradeID`)*/
    unique index (`SubAccountId`, `InstrumentID`, `HedgeFlag`, `Direction`, `TradeType`, `OpenDate`, `TradeID`)
) comment '子账户持仓明细表';

drop table if exists SubNpfuturesOrder;
create table SubNpfuturesOrder
(
    id                        bigint                   not null comment '主键' primary key,
    SubAccountId              bigint(20)               not null comment '子账户AM平台账户ID',
    /*
    ...
    */
    ...
    ClientID                  varchar(12)              not null comment '客户代码',
    ...
    /*AccountID               varchar(14)              not null comment '资金账号',*/
    ...
    MotherOrderId             bigint(20)               not null comment '母账户唯一委托订单ID',
    FrozenMargin              decimal(22, 8) default 0 not null comment '冻结的保证金',
    FrozenCash                decimal(22, 8) default 0 not null comment '冻结的资金',
    FrozenCommission          decimal(22, 8) default 0 not null comment '冻结的手续费',
    RemainFrozenMargin        decimal(22, 8) default 0 not null comment '剩余冻结保证金',
    RemainFrozenCase          decimal(22, 8) default 0 not null comment '剩余冻结资金',
    RemainFrozenCommission    decimal(22, 8) default 0 not null comment '剩余冻结手续费',
    /*unique index (`SubAccountId`, `FrontID`, `SessionID`, `OrderRef`, `ExchangeID`, `OrderSysID`)*/
    unique index (`SubAccountId`, `FrontID`, `SessionID`, `OrderRef`, `ExchangeID`, `OrderSysID`)
) comment '子账户委托订单表';

drop table if exists SubNpfuturesTrade;
create table SubNpfuturesTrade
(
    id                  bigint                   not null comment '主键' primary key,
    SubAccountId        bigint(20)               not null comment '子账户AM平台账户ID',
    /*
    ...
    */
    ...
    ParticipantID       varchar(12)              not null comment '会员代码',
    ClientID            varchar(12)              not null comment '客户代码',
    TradingRole         char(1)                  not null comment '交易角色(交易角色类型数据字典)',
    ...
    TradeType           char(1)                  not null comment '成交类型(成交类型类型数据字典)',
    PriceSource         char(1)                  not null comment '成交价来源(成交价来源类型数据字典)',
    TraderID            varchar(22)              not null comment '交易所交易员代码',
    OrderLocalID        varchar(14)              not null comment '本地报单编号',
    ClearingPartID      varchar(12)              not null comment '结算会员编号',
    BusinessUnit        varchar(22)              not null comment '业务单元',
    SequenceNo          int(11)                  not null comment '序号',
    TradingDay          varchar(10)              not null comment '交易日',
    SettlementID        int(11)                  not null comment '结算编号',
    BrokerOrderSeq      int(11)                  not null comment '经纪公司报单编号',
    TradeSource         char(1)                  not null comment '成交来源(成交来源类型数据字典)',
    InvestUnitID        varchar(18)              not null comment '投资单元代码',
    MotherTradeId       bigint(20)               not null comment '母账户唯一成交ID',
    /*unique index (`SubAccountId`, `ExchangeID`, `TradeID`, `Direction`)*/
    unique index (`SubAccountId`, `ExchangeID`, `TradeID`, `Direction`)
) comment '子账户成交表';

drop table if exists SubNpfuturesOrderHis;
create table SubNpfuturesOrderHis
(
    id                        bigint                   not null comment '主键' primary key,
    SubAccountId              bigint(20)               not null comment '子账户AM平台账户ID',
    /*

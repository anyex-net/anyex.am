...
drop table if exists NpfuturesAccountInfo;
create table NpfuturesAccountInfo
(
...
drop table if exists NpfuturesTradingAccount;
create table NpfuturesTradingAccount
(
    id                                      bigint                   not null comment '主键' primary key,
    accountId                               bigint(20)               not null comment 'AM平台账户ID',
    BrokerID                                varchar(12)              not null comment '经纪公司代码',
    ...
    unique index (`accountId`, `BrokerID`, `InvestorID`, `TradingDay`)
) comment '内盘期货资金账户息表';

drop table if exists NpfuturesInstrumentMarginRate;
create table NpfuturesInstrumentMarginRate
(
    id                          bigint                              not null comment '主键' primary key,
    accountId                   bigint(20)                          not null comment 'AM平台账户ID',
    brokerID                    varchar(12)                         not null comment '经纪公司代码',
...
drop table if exists NpfuturesInstrumentCommissionRate;
create table NpfuturesInstrumentCommissionRate
(
    id                          bigint                              not null comment '主键' primary key,
    accountId                   bigint(20)                          not null comment 'AM平台账户ID',
    brokerID                    varchar(12)                         not null comment '经纪公司代码',
    ...
    exchangeID                  varchar(10)                         not null comment '交易所代码',
    bizType                     char                                not null comment '业务类型',
    investUnitID                varchar(18)                         not null comment '投资单元代码',
    unique index (`accountId`, `brokerID`, `investorID`, `instrumentID`)
) comment '内盘期货合约手续费率表';

drop table if exists NpfuturesInstrumentOrderCommRate;
create table NpfuturesInstrumentOrderCommRate
(
    id                          bigint                              not null comment '主键' primary key,
    accountId                   bigint(20)                          not null comment 'AM平台账户ID',
    brokerID                    varchar(12)                         not null comment '经纪公司代码',
    ...
    investUnitID                varchar(18)                         not null comment '投资单元代码',
    unique index (`accountId`, `brokerID`, `investorID`, `instrumentID`, `hedgeFlag`)
) comment '内盘期货报单手续费表(中金所持有)';

drop table if exists NpfuturesBrokerTradingParams;
create table NpfuturesBrokerTradingParams
(
    id                          bigint                              not null comment '主键' primary key,
    accountId                   bigint(20)                          not null comment 'AM平台账户ID',
    brokerID                    varchar(12)                         not null comment '经纪公司代码',
    ...
    unique index (`accountId`, `brokerID`, `investorID`)
) comment '内盘期货经纪公司交易参数表';

drop table if exists NpfuturesInvestorPositionDetail;
create table NpfuturesInvestorPositionDetail
(
    id                       bigint                    not null comment '主键' primary key,
    accountId                bigint(20)                not null comment 'AM平台账户ID',
    ...
    unique index (`accountId`, `InstrumentID`, `BrokerID`, `InvestorID`, `HedgeFlag`, `Direction`, `TradeType`, `OpenDate`, `TradeID`)
) comment '内盘期货持仓明细表';

drop table if exists NpfuturesInvestorPosition;
create table NpfuturesInvestorPosition
(
    id                       bigint                   not null comment '主键' primary key,
    accountId                bigint(20)               not null comment 'AM平台账户ID',
    InstrumentID             varchar(32)              not null comment '合约代码',
    ...
    unique index (`accountId`, `InstrumentID`, `BrokerID`, `InvestorID`, `PosiDirection`, `HedgeFlag`, `PositionDate`)
) comment '内盘期货持仓汇总表';

drop table if exists NpfuturesOrder;
create table NpfuturesOrder
(
    id                    bigint                   not null comment '主键' primary key,
    accountId             bigint(20)               not null comment 'AM平台账户ID',
    BrokerID              varchar(12)              not null comment '经纪公司代码',
    ...
    unique index (`accountId`, `FrontID`, `SessionID`, `OrderRef`, `ExchangeID`, `OrderSysID`)
) comment '内盘期货委托订单表';

drop table if exists NpfuturesTrade;
create table NpfuturesTrade
(
    id                  bigint                   not null comment '主键' primary key,
    accountId           bigint(20)               not null comment 'AM平台账户ID',
    BrokerID            varchar(12)              not null comment '经纪公司代码',
...
drop table if exists NpfuturesOrderHis;
create table NpfuturesOrderHis
(
    id                    bigint                   not null comment '主键' primary key,
    accountId             bigint(20)               not null comment 'AM平台账户ID',
    BrokerID              varchar(12)              not null comment '经纪公司代码',

...
drop table if exists SubWpSpotAccountInfo;
create table SubWpSpotAccountInfo
(
    Id                              bigint        not null comment '主键' primary key,
    SubAccountId                    bigint(20)    not null comment '子账户AM平台账户ID',
    MotherWpSpotAccountInfoId       bigint(20)    not null comment '母账户外盘现货投资者帐号ID',
    Remark                          varchar(256)  not null comment '备注',
    unique index (`subAccountId`)
) comment '子账户投资帐号信息表';

drop table if exists SubWpSpotTradingAccount;
create table SubWpSpotTradingAccount
(
    id                                      bigint                   not null comment '主键' primary key,
    SubAccountId                            bigint(20)               not null comment '子账户AM平台账户ID',
...
drop table if exists SubWpSpotPositionDetail;
create table SubWpSpotPositionDetail
(
    Id                       bigint                    not null comment '主键' primary key,
    SubAccountId             bigint(20)                not null comment '子账户AM平台账户ID',
    ...
    unique index (`SubAccountId`, `ExchangeID`, `InstrumentID`, `Direction`, `TradeID`, `OpenDate`)
) comment '子账户持仓明细表';

drop table if exists SubWpSpotPosition;
create table SubWpSpotPosition
(
    Id                       bigint                   not null comment '主键' primary key,
    SubAccountId             bigint(20)               not null comment '子账户AM平台账户ID',
    InstrumentID             varchar(32)              not null comment '合约代码',
    ...
    unique index (`SubAccountId`, `ExchangeID`, `InstrumentID`, `PosiDirection`, `PositionDate`)
) comment '子账户持仓汇总表';

drop table if exists SubWpSpotOrder;
create table SubWpSpotOrder
(
    Id                      bigint                   not null comment '主键' primary key,
    SubAccountId               bigint(20)            not null comment '子账户AM平台账户ID',
    #BrokerID                varchar(12)              not null comment '经纪公司代码',
    ...
    OpenRatioByMoney        decimal(22, 8) default 0 not null comment '开仓手续费率', 
    CloseRatioByMoney       decimal(22, 8) default 0 not null comment '平仓手续费率',
    CloseTodayRatioByMoney  decimal(22, 8) default 0 not null comment '平今手续费率',
    unique index (`SubAccountId`, `FrontID`, `SessionID`, `OrderRef`)
) comment '子账户委托订单表';

drop table if exists SubWpSpotTrade;
create table SubWpSpotTrade
(
    Id                  bigint                   not null comment '主键' primary key,
    SubAccountId           bigint(20)               not null comment '子账户AM平台账户ID',
    #BrokerID            varchar(12)              not null comment '经纪公司代码',
...
drop table if exists SubWpSpotOrderHis;
create table SubWpSpotOrderHis
(
    Id                     bigint                   not null comment '主键' primary key,
    SubAccountId           bigint(20)               not null comment '子账户AM平台账户ID',
    #BrokerID               varchar(12)              not null comment '经纪公司代码',

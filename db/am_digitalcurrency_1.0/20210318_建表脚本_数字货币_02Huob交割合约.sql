...
drop table if exists HuobiFuturesCoinInstruments;
create table HuobiFuturesCoinInstruments
(
    ...
    deliveryDate   varchar(30) comment '合约交割日期',
    createDate     varchar(30) comment '合约上市日期',
    settlementTime varchar(30) comment '下次结算时间',
    deliveryTime   varchar(30) comment '交割时间',
    contractStatus varchar(30) comment '合约状态',
    unique index (contractCode)
) comment '交割合约(币)交易对';

drop table if exists HuobiFuturesAccountAsset;
create table HuobiFuturesAccountAsset
(
    id                bigint       not null comment '主键' primary key,
...
drop table if exists HuobiFuturesAccountPosition;
create table HuobiFuturesAccountPosition
(
    id             bigint       not null comment '主键' primary key,
    accountId      bigInt(20)   not null comment '平台账户ID',
    apiKey         varchar(255) not null comment '外部平台apikey',
...
drop table if exists HuobiFuturesFinancialRecord;
create table HuobiFuturesFinancialRecord
(
    id           bigint       not null comment '主键' primary key,
    accountId    bigInt(20)   not null comment '平台账户ID',
    apiKey       varchar(255) not null comment '外部平台apikey',
...
drop table if exists HuobiFuturesSettlementRecord;
create table HuobiFuturesSettlementRecord
(
    id                   bigint       not null comment '主键' primary key,
    accountId            bigInt(20)   not null comment '平台账户ID',
    apiKey               varchar(255) not null comment '外部平台apikey',
    ...
    deliveryFee          decimal(24, 12) comment '本期交割手续费',
...
drop table if exists HuobiFuturesOrder;
create table HuobiFuturesOrder
(
    id              bigint       not null comment '主键' primary key,
    accountId       bigInt(20)   not null comment '平台账户ID',
    apiKey          varchar(255) not null comment '外部平台apikey',
...
drop table if exists HuobiFuturesOrderDetail;
create table HuobiFuturesOrderDetail
(
    id               bigint       not null comment '主键' primary key,
    accountId        bigInt(20)   not null comment '平台账户ID',
    apiKey           varchar(255) not null comment '外部平台apikey',
...
drop table if exists HuobiFuturesOrderPlan;
create table HuobiFuturesOrderPlan
(
    id              bigint       not null comment '主键' primary key,
    accountId       bigInt(20)   not null comment '平台账户ID',
    apiKey          varchar(255) not null comment '外部平台apikey',
...
drop table if exists HuobiFuturesOrderTpsl;
create table HuobiFuturesOrderTpsl
(
    id                  bigint       not null comment '主键' primary key,
    accountId           bigInt(20)   not null comment '平台账户ID',
    apiKey              varchar(255) not null comment '外部平台apikey',
